...
import { COLLISION_MARGIN, Force, PENALTY_MAX, PENALTY_MIN, STICK_THRESH,                             } from './body.js?v=1';
import { collide } from './collide.js?v=1';
import {
  addm,
  addScaled3,
  clamp,
...
function angularJacobian(out    , r    , lin    )     {
  for (let k = 0; k < 3; k++) {
    row[0] = lin[k * 3];
    row[1] = lin[k * 3 + 1];
    row[2] = lin[k * 3 + 2];

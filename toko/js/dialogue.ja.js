...
export const JA = {
  ...
  CHANGED: [
    ...
    {
      when: '2026-07', game: 'hub',
      what: ['ゲームの隅にある俺の印は、もう扉だ。',
        'ここに繋がっている。'],
    },
    {
      when: '2026-07', game: 'hub',
      what: ['このカウンターへのリンクは、フロアから',
        '一度も動いていなかった。今は動く。'],
    },
    {
      when: '2026-07', game: 'sudsjack',
      what: ['作り直しは寝そべる半分のトンネルになった。',
        '五つの窪みと、跳躍。'],
    },
    {
      when: '2026-08', game: 'hyperdagger',
      what: ['あの表紙は別のゲームのものだった。',
        '空は消えた。群れを照らす唯一の光は',
        'お前自身の短剣の流れだ。'],
    },
    {
      when: '2026-08', game: 'hub',
      what: ['十六のページが数か月前のホームボタンを',
        'キャッシュから出していた。',
        '今はどれも最新のものを取りに行く。'],
    },
    {
      when: '2026-08', game: 'hub',
      what: ['ブラウン管がガラス全面で灯るようになった。',
        '俺の印はメニューの前ではなく、',
        '最初の一戦の前に流れる。',
        '二種類ある。お前が見たのは片方だ。'],
    },
    {
      when: '2026-08', game: 'hub',
      what: ['俺は電波がなくても動くようになった。',
        'フロア全体は最初からそうだった。'],
    },
    {
      when: '2026-08', game: 'hub',
      what: ['お前の最高記録がキャビネットに出ている。',
        '自分の機械から読んだだけで、どこにも送らない。'],
    },
  ],

  GAME_NOTES: {
    sudsjack: ['名前の由来。石鹸だらけの水路だ。',
      '遊べるのは今も古いベクター版。',
      '作り直しは、寝そべる半分のトンネル。',
      '銃はない。拾って、跳ぶ。'],

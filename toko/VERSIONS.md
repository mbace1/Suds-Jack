...
Assistant-only capability work after v5 is tracked separately in
[`PATCH_NOTES.md`](PATCH_NOTES.md) so the brand release number does not drift
from the counter's gated `VERSION` constant.

...
const RUN = [
  [ .12,-.10, .05,-.05,-.75, .65, .72,-.58,-.25,.78,-.25,.18], // contact L
  [ .08,-.04, .02,-.03,-.35, .28, .32,-.18, .18,.42,-.05,.05], // down
  [ .10, .08,-.04,-.04, .35,-.28,-.32, .18, .72,.20, .16,-.02], // passing
  [ .14, .12,-.06,-.06, .72,-.58,-.58, .62, .86,-.18, .28,-.20], // flight R
  [ .12, .10,-.05,-.05, .75,-.65,-.72, .58, .78,-.25, .18,-.25], // contact R
  [ .08, .04,-.02,-.03, .35,-.28,-.32, .18, .42,.18, .05,-.05], // down
  [ .10,-.08, .04,-.04,-.35, .28, .32,-.18, .20,.72,-.02,.16], // passing
  [ .14,-.12, .06,-.06,-.72, .58, .58,-.62,-.18,.86,-.20,.28], // flight L
];

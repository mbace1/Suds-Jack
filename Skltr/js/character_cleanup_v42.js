...
function clean(b){
  ...
  // Remove inherited rabbit facial pieces; retain only the rig transform and Toko expression.
  for(const child of [...b.head.children])if(child!==toko)child.visible=false;
  // Remove the rear puff/tail geometry without touching hips/chest.
  ...
  // Occasional accessory, never anatomy. URL ?ears=1 forces it for visual QA, ?ears=0 disables it.

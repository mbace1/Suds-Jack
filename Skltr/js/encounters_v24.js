...
const CARDS=[
 ...
 R('LINK 1 · RUN',24),
 // v48: TORTOISE teaches lane choice. Fewer simultaneous anchors, more readable escorts.
 ...
 R('LINK 2 · CLIMB',30),
 // v48: WASP asks the player to change vertical attention, never just adds density.

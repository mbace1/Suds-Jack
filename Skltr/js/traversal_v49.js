...
const hud=document.createElement('div');hud.id='skltr-traverse';Object.assign(hud.style,{position:'fixed',left:'50%',top:'17%',transform:'translateX(-50%)',zIndex:'60',font:'700 11px/1.35 monospace',letterSpacing:'3px',color:'#9bfff0',textAlign:'center',textShadow:'0 0 12px #50ffdc',pointerEvents:'none',opacity:'0',transition:'opacity .2s'});document.body.appendChild(hud);

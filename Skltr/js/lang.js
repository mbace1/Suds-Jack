...
const STRINGS = {
  en: {
    ...
    visualTestH: 'Stylized desert — sun-bleached sand, ink outlines, cacti (experimental)',
    depthTestH: 'Canyon run — constant forward push, boulders, sweepers, lap the run (experimental)',
    youDied: 'DOWN',
  ...
  ja: {
    ...
    visualTestH: '様式化された砂漠 — 陽に灼けた砂とインクの線画（実験的機能）',
    depthTestH: 'キャニオンラン — 前進し続ける渓谷走、岩を跳び越えて周回（実験的機能）',
    youDied: 'ダウン',
    ...
    visualTestH: 'Tyylitelty aavikko — auringon polttama hiekka, mustetta viivoina (kokeellinen)',
    depthTestH: 'Kanjonijuoksu — jatkuva eteenpäin työntö, kierrä rata (kokeellinen)',
    youDied: 'KAADUIT',

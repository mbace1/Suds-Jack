...
As of 2026-09-06, the core Toko Live source on `main` is reconciled through v44 with the deployed `gh-pages` architecture.

Synced on `main`:

- `main.js` — same spatial/card/performance runtime as the deployed core
- `index.html` — v44 shell and version labeling

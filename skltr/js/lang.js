...
const STRINGS = {
  en: {
    ...
    visualTestH: 'Neon-arcade render pass: color fills, RGB shift, scanlines (experimental)',
    depthTestH: 'Floating islands over a bottomless void — fall and it\'s over (experimental)',
    youDied: 'DOWN',
  ...
  ja: {
    ...
    visualTestH: 'ネオンアーケード表現：色塗り・RGBずれ・走査線（実験的機能）',
    depthTestH: '底なしの虚空に浮かぶ島々 — 落ちれば終わり（実験的機能）',
    youDied: 'ダウン',
    ...
    visualTestH: 'Neon-arcade-tehoste: väritäytöt, RGB-siirtymä, kuvaviivat (kokeellinen)',
    depthTestH: 'Kelluvia saaria pohjattoman tyhjyyden yllä — putoaminen on kuolemaksi (kokeellinen)',
    youDied: 'KAADUIT',

...
import { CFG, EnemyType, Enemy, GOO_TIME, applySatinValues } from './enemy.js?v=193';
import { t } from './lang.js?v=193';
import { TUNING, applyMaterialPreset } from './tuning.js?v=193';
import { Arena, rectShape } from './arena.js?v=193';
...
const TYPE_NAMES = {
  ...
  [EnemyType.GHOST]:       'GHOST (gaundrop)',
  [EnemyType.WRAITH]:      'WRAITH (gaundrop)',
  [EnemyType.FLIT]:        'FLIT (binding)',
  [EnemyType.SPITTLE]:     'SPITTLE (binding)',
  [EnemyType.CHARGER]:     'CHARGER (binding)',
  [EnemyType.HOPPER]:      'HOPPER (binding)',
  [EnemyType.TURRET]:      'TURRET (loadout)',
  [EnemyType.TROOPER]:     'TROOPER (loadout)',
  [EnemyType.THUG]:        'THUG (kaikki)',
  [EnemyType.DRAPER]:      'DRAPER (curtains)',
  [EnemyType.PRISM]:       'PRISM (twin boss)',
  [EnemyType.CUSTODIAN]:   'CUSTODIAN (nex boss)',
  [EnemyType.SHEPHERD]:    'SHEPHERD (fluid)',
};

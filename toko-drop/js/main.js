...
import { BulletPool, BULLET_R, FAT_BULLET_R, BULLET_CONFIG } from './bullet.js?v=13';
import { Player, PLAYER_RADIUS } from './player.js?v=13';
import { Enemy, EnemyType, GOO_TIME, makeGooMat } from './enemy.js?v=13';
import { audio } from './audio.js?v=13';
import { initDesigner } from './designer.js?v=13';
...
function drawHUD() {
  ...
  ctx.font = '10px monospace';
  ctx.textAlign = 'left';
  ctx.fillText('v57', 16, uiCanvas.height - 12);

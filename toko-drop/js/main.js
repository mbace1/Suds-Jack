...
import { BulletPool, BULLET_R, FAT_BULLET_R, BULLET_CONFIG } from './bullet.js?v=57';
import { Player, PLAYER_RADIUS } from './player.js?v=57';
import { Enemy, EnemyType, GOO_TIME, makeSatinMat, applySatinValues } from './enemy.js?v=57';
import { audio } from './audio.js?v=57';
import { initDesigner } from './designer.js?v=57';
import { t, getLang, setLang, langs } from './lang.js?v=57';
...
function drawHUD() {
  ...
  ctx.font = '10px monospace';
  ctx.textAlign = 'left';
  ctx.fillText('v103', 16, uiCanvas.height - 12);

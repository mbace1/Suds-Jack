...
import { BulletPool, BULLET_R, FAT_BULLET_R, BULLET_CONFIG } from './bullet.js?v=44';
import { Player, PLAYER_RADIUS } from './player.js?v=44';
import { Enemy, EnemyType, GOO_TIME, makeGooMat } from './enemy.js?v=44';
import { audio } from './audio.js?v=44';
import { initDesigner } from './designer.js?v=44';
import { t, getLang, setLang, langs } from './lang.js?v=44';
...
function drawHUD() {
  ...
  ctx.font = '10px monospace';
  ctx.textAlign = 'left';
  ctx.fillText('v90', 16, uiCanvas.height - 12);

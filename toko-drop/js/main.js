...
import { BulletPool, BULLET_R, FAT_BULLET_R, BULLET_CONFIG } from './bullet.js?v=9';
import { Player, PLAYER_RADIUS } from './player.js?v=9';
import { Enemy, EnemyType, GOO_TIME, makeGooMat } from './enemy.js?v=9';
import { audio } from './audio.js?v=9';
import { initDesigner } from './designer.js?v=9';
...
function drawHUD() {
  ...
  ctx.font = '10px monospace';
  ctx.textAlign = 'left';
  ctx.fillText('v53', 16, uiCanvas.height - 12);

...
for f in toko-drop/index.html toko-drop/enemy-lab.html toko-drop/js/main.js toko-drop/js/player.js toko-drop/js/designer.js toko-drop/js/lang.js toko-drop/js/enemy.js toko-drop/js/audio.js toko-drop/js/retro.js toko-drop/js/specimen.js toko-drop/sw.js toko-drop/vendor/three.webgpu.min.js; do

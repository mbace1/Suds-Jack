...
// The Meshy enemy models. They are named by mesh-enemies.js through
// `new URL(...)`, which no reference pattern sees, and they are the one part
// of this list allowed to be absent: the loader catches and falls back to the
// voxel models, and the worker adds each entry separately so a miss costs
// nothing. They stay listed so that the day the art lands it is already cached.

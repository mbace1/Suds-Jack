...
transport. The clock is reset on the way back, or the first frame carries the whole conversation. Measured on main: the rider froze at exactly the same z for three seconds with him open.

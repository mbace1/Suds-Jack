...
// The board, as boardBox() derives it from the twenty-two delivery anchors (twenty-two at v2.62: Töölöntori out, Kruunuvuori in; twenty-three at v2.63 with Laajasalo).
...
export const BOARD_BOX = { s: 60.1443, w: 24.8895, n: 60.2199, e: 25.0662 };

...
import { legPoints } from './geometry.js?v=4';
import { TOUCH } from './palette.js?v=4';
import { nubs } from './lines.js?v=4';
...
export class LineDrawer {
  ...
  nubs() { return nubs(this.game.net, this.game.world, this.nubGap); }

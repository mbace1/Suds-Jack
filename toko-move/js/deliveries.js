...
const DESTINATIONS=['rautatientori','hakaniemi','sornainen','kalasatama','pasila','kamppi','kauppatori','katajanokka','lansiterminaali','hietalahti','meilahti','arabia','kruunuvuori','laajasalo','olympiaterminaali','eira','kapyla','messukeskus','lasipalatsi','ooppera','senaatintori'];

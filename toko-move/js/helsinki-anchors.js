...
export const HELSINKI_ANCHORS = {
  ...
  ruoholahti:['Ruoholahti','Ruoholahden metroasema'], kauppatori:['Kauppatori'], katajanokka:['Katajanokan puisto','Katajanokan terminaali','Vyökatu'],
  ...
  kruunuvuori:['Kruunuvuori'], laajasalo:['Yliskylän keskusta']
};

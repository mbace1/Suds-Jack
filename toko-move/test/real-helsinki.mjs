...
assert.equal(city.nodes.length,18,'delivery board exposes eighteen real HSL anchors');
...
for(const id of ['lasipalatsi','ooppera','messukeskus','lansiterminaali','eira','kapyla'])assert.ok(city.nodes.some(n=>n.id===id),`${id} expanded anchor exists`);

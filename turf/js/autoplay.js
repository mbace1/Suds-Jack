...
import { manhattan, hasLOS, coverSoftens, key } from './grid.js?v=5';
import { movableTiles, attackableTargets, moveUnit, orderAttack, endUnitTurn, useAbility, reloadUnit } from './combat.js?v=21';
import { needsReload } from './ammo.js?v=3';
import { abilitiesFor, canAfford, abilityTargets } from './abilities.js?v=3';

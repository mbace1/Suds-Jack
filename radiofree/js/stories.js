...
import { PANEL_KEYS } from './visuals.js?v=7';
import { BROLL_KEYS } from './broll.js?v=7';
import { SECTOR_COLOR } from './palette.js?v=7';
import { validateWire, orderByChannel, pickCopy } from './wire.js?v=7';

export { parseLine, flatten } from './wire.js?v=7';
...
const OFF_AIR = {
  ...
  stories: [{ id: 'station-id', sector: 'GAMING', visual: 'sat', broll: 'treeline' }],
  copy: {
    en: {
      'station-id': {

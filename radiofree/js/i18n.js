...
const STR = {
  ...
  en: {
    ...
    'off.p1': 'Twelve stories out of a day. Somebody chose them, and somebody put them in an order, and that somebody was this station.',
    ...
    'off.all': 'All twelve. Go and find one of these in something real.',
  ...
  // ────────────────────────────────────────────────── Suomi
    ...
    'off.p1': 'Kaksitoista juttua yhdestä päivästä. Joku valitsi ne, ja joku pani ne järjestykseen, ja se joku oli tämä asema.',
    ...
    'off.all': 'Kaikki kaksitoista. Mene nyt etsimään yksi näistä jostakin oikeasta.',
  ...
  ja: {
    ...
    'off.p1': '一日から十二本。誰かがそれを選び、誰かが順番をつけた。その誰かが、この局だ。',
    ...
    'off.all': '十二本すべて。あとは本物のどれかで、この手口をひとつ見つけにいくこと。',

...
const SHELL = [
  ...
  './icon-192.png',
  './icon-512.png',
  ...['main', 'codec', 'package', 'anchor', 'graphic', 'plate', 'photo', 'plates', 'wire', 'toko', 'visuals', 'ambient', 'retrocity', 'tram', 'centralstation', 'katajanokka', 'stories', 'i18n', 'screen', 'audio', 'palette']
    .map(m => `./js/${m}.js${V}`),
];

...
const SHELL = [
  ...
  ...['main','codec','package','anchor','graphic','plate','photo','plates','wire','toko','visuals','ambient','retrocity','tram','centralstation','katajanokka','broadcastfx','stories','i18n','screen','audio','palette'].map(m => `./js/${m}.js${V}`),
];

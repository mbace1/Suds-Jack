...
import { t, setLang, getLang, LANGS } from './i18n.js?v=24';
import { PAL } from './palette.js?v=24';
import { PixelScreen, shade } from './pixel.js?v=24';
import * as store from './storage.js?v=24';
import * as audio from './audio.js?v=24';
import { pickInterlude, isEvening } from './nature.js?v=24';
import { aqueduct } from './experiences/aqueduct.js?v=24';
import { forest } from './experiences/forest.js?v=24';
import { tern } from './experiences/tern.js?v=24';
import { cup } from './experiences/cup.js?v=24';
import { hanami } from './experiences/hanami.js?v=24';
import { berry } from './experiences/berry.js?v=24';
import { stars } from './experiences/stars.js?v=24';
import { maple } from './experiences/maple.js?v=24';
import { plate } from './experiences/plate.js?v=24';
import { seam } from './experiences/seam.js?v=24';
import { dots } from './experiences/dots.js?v=24';
import { glass } from './experiences/glass.js?v=24';
import { wait } from './experiences/wait.js?v=24';
import { lichen } from './experiences/lichen.js?v=24';
import { cloud } from './experiences/cloud.js?v=24';
import { ice } from './experiences/ice.js?v=24';
import { trace } from './experiences/trace.js?v=24';
import { gears } from './experiences/gears.js?v=24';
import { cairn } from './experiences/cairn.js?v=24';
import { downhill } from './experiences/downhill.js?v=24';

const REGISTRY = [aqueduct, forest, tern, cup, hanami, berry, stars, maple, plate, seam, dots, glass, wait, lichen, cloud, ice, trace, gears, cairn, downhill];

...
import { t, setLang, getLang, LANGS } from './i18n.js?v=23';
import { PAL } from './palette.js?v=23';
import { PixelScreen, shade } from './pixel.js?v=23';
import * as store from './storage.js?v=23';
import * as audio from './audio.js?v=23';
import { pickInterlude, isEvening } from './nature.js?v=23';
import { aqueduct } from './experiences/aqueduct.js?v=23';
import { forest } from './experiences/forest.js?v=23';
import { tern } from './experiences/tern.js?v=23';
import { cup } from './experiences/cup.js?v=23';
import { hanami } from './experiences/hanami.js?v=23';
import { berry } from './experiences/berry.js?v=23';
import { stars } from './experiences/stars.js?v=23';
import { maple } from './experiences/maple.js?v=23';
import { plate } from './experiences/plate.js?v=23';
import { seam } from './experiences/seam.js?v=23';
import { dots } from './experiences/dots.js?v=23';
import { glass } from './experiences/glass.js?v=23';
import { wait } from './experiences/wait.js?v=23';
import { lichen } from './experiences/lichen.js?v=23';
import { cloud } from './experiences/cloud.js?v=23';
import { ice } from './experiences/ice.js?v=23';
import { trace } from './experiences/trace.js?v=23';
import { gears } from './experiences/gears.js?v=23';
import { cairn } from './experiences/cairn.js?v=23';

const REGISTRY = [aqueduct, forest, tern, cup, hanami, berry, stars, maple, plate, seam, dots, glass, wait, lichen, cloud, ice, trace, gears, cairn];

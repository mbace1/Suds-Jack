...
import { t, setLang, getLang, LANGS } from './i18n.js?v=25';
import { PAL } from './palette.js?v=25';
import { PixelScreen, shade } from './pixel.js?v=25';
import * as store from './storage.js?v=25';
import * as audio from './audio.js?v=25';
import { pickInterlude, isEvening } from './nature.js?v=25';
import { aqueduct } from './experiences/aqueduct.js?v=25';
import { forest } from './experiences/forest.js?v=25';
import { tern } from './experiences/tern.js?v=25';
import { cup } from './experiences/cup.js?v=25';
import { hanami } from './experiences/hanami.js?v=25';
import { berry } from './experiences/berry.js?v=25';
import { stars } from './experiences/stars.js?v=25';
import { maple } from './experiences/maple.js?v=25';
import { plate } from './experiences/plate.js?v=25';
import { seam } from './experiences/seam.js?v=25';
import { dots } from './experiences/dots.js?v=25';
import { glass } from './experiences/glass.js?v=25';
import { wait } from './experiences/wait.js?v=25';
import { lichen } from './experiences/lichen.js?v=25';
import { cloud } from './experiences/cloud.js?v=25';
import { ice } from './experiences/ice.js?v=25';
import { trace } from './experiences/trace.js?v=25';
import { gears } from './experiences/gears.js?v=25';
import { cairn } from './experiences/cairn.js?v=25';
import { downhill } from './experiences/downhill.js?v=25';

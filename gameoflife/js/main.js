...
import { t, setLang, getLang, LANGS } from './i18n.js?v=41';
import { PAL, setAccent, accentRgb } from './palette.js?v=41';
import { setAccentAll, unwarp, liveCount } from './crt.js?v=41';
import * as store from './storage.js?v=41';
import * as crt from './crt.js?v=41';
import * as audio from './audio.js?v=41';
import { pickInterlude, isEvening, guessHemisphere } from './nature.js?v=41';
import * as outbound from './feedback.js?v=41';
import { aqueduct } from './experiences/aqueduct.js?v=41';
import { forest } from './experiences/forest.js?v=41';
import { tern } from './experiences/tern.js?v=41';
import { cup } from './experiences/cup.js?v=41';
import { hanami } from './experiences/hanami.js?v=41';
import { berry } from './experiences/berry.js?v=41';
import { stars } from './experiences/stars.js?v=41';
import { maple } from './experiences/maple.js?v=41';
import { plate } from './experiences/plate.js?v=41';
import { seam } from './experiences/seam.js?v=41';
import { dots } from './experiences/dots.js?v=41';
import { glass } from './experiences/glass.js?v=41';
import { wait } from './experiences/wait.js?v=41';
import { lichen } from './experiences/lichen.js?v=41';
import { cloud } from './experiences/cloud.js?v=41';
import { ice } from './experiences/ice.js?v=41';
import { trace } from './experiences/trace.js?v=41';
import { gears } from './experiences/gears.js?v=41';
import { cairn } from './experiences/cairn.js?v=41';
import { downhill } from './experiences/downhill.js?v=41';
import { tether } from './experiences/tether.js?v=41';
import { hedge } from './experiences/hedge.js?v=41';
import { seed } from './experiences/seed.js?v=41';
import { lightning } from './experiences/lightning.js?v=41';
import { whale } from './experiences/whale.js?v=41';
import { pando } from './experiences/pando.js?v=41';
import { murmur } from './experiences/murmur.js?v=41';
import { eel } from './experiences/eel.js?v=41';

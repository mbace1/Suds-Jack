...
import { slugOf, parseSlug, PER_WORLD } from '../js/levelid.js?v=52';
import { ROOMS, LAB } from '../js/rooms.js?v=52';
import {
...
{
  const { PROPS, SCENERY, withDefaults } = await import('../js/scenery.js?v=52');
  const bad = [];

...
import { slugOf, parseSlug, PER_WORLD } from '../js/levelid.js?v=48';
import { ROOMS, LAB } from '../js/rooms.js?v=48';
import {
...
{
  const { PROPS, SCENERY, withDefaults } = await import('../js/scenery.js?v=48');
  const bad = [];

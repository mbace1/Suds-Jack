...
import { PAL, LAYER_Z, LAYER_TINT, mix } from './palette.js?v=47';
import { getLayerTexture } from './assets.js?v=47';
import { buildPipeworksDressing } from './world2-dressing.js?v=47';

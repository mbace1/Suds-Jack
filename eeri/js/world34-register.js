...
// this shim mutates the SAME rooms.js?v=45 array that level.js re-exports.
...
import { ROOMS } from './rooms.js?v=45';
import { WORLD34_ROOMS } from './world34-rooms.js?v=45';
...
if (typeof window !== 'undefined') import('./world34-dressing.js?v=45');

...
export const BIOMES = [
  biome('jungle', [
    '#000000', '#181038', '#4a1c4e', '#12253f', '#0e3646', '#0a2028',
    '#4f9a6c', '#1a4232', '#050f0d', '#46e0c0', '#c8ff6e', '', '', '', '', '#d83a3a',
  ]),
  biome('dig', [
    '#000000', '#1c1630', '#5c3446', '#222a3a', '#2b3a2c', '#1a201c',
    '#8d8055', '#3a4433', '#070a08', '#4ad8c4', '#e8b45c', '', '', '', '', '#d83a3a',
  ]),
  biome('tomb', [
  ...
  biome('reactor', [
    '#000000', '#0d1420', '#243f52', '#131c28', '#1b2b3a', '#16212c',
    '#8ad4e8', '#2c4450', '#070a10', '#5cf6ff', '#ff8a2a', '', '', '', '', '#ff4438',
  ]),
  biome('palace', [
  ...
  biome('flooded city', [
    '#000000', '#111a31', '#2d4961', '#193747', '#245160', '#132e39',
    '#92b9b5', '#3f6968', '#07161b', '#56d9cf', '#d8ef9a', '', '', '', '', '#d65b55',
  ]),
];

...
| `flash-prince.png` | the playable non-run actions, recoloured to the locked v18 run's exact seven colours and given its clean one-pixel contour. Generated by `recolour_flashprince.py`. |

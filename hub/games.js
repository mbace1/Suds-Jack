...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'hyperDaggerHi', fmt: 'secs' },
      ...
      tagline: 'Devil Daggersista inspiroitunut riisuttu areena-FPS: vinottaisvauhti, vauhtihypyt, tikarihypyt, rosoinen musta lattia ja leveäsarviset luudemonit.',
    ...
    ja: {
      tagline: 'Devil Daggersに着想を得た簡潔なアリーナFPS。斜め移動の加速、慣性ホップ、ダガージャンプ、荒い黒床、横に広い角付き骸骨。',
      lineage: 'Devil Daggers',
    ...
    status: 'active',
    title: 'Hyper Dagger',
    tagline: 'A stripped-down arena FPS inspired by Devil Daggers: diagonal speed, momentum hops, dagger jumps, a rough black floor, and wide horned skulls.',
    lineage: 'Devil Daggers',

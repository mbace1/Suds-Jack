...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.34 — kentät eivät enää jätä pitkiä tyhjiä pätkiä: maailmoissa 3 ja 4 oli kussakin kahdenkymmenen ruudun kohta jossa ei tapahtunut mitään. Nyt niissä on ponnahduslautoja, hihna, putki ja ensimmäiset höyryventtiilinsä.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.34 — 何も起きない長い区間をなくした。ワールド3と4にはそれぞれ20マス分の空白があった。トランポリン、ベルト、パイプ、そして初めての蒸気バルブが入った。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.34 — no level goes twenty tiles without asking you for something any more: worlds 3 and 4 each had a stretch that long where nothing happened at all. They have bounces, a belt, a pipe home and their first steam vents now — and two enemies that had been standing in a machine\u2019s path since the day those levels were built have moved out of it.',
    title: 'Eeri',
  ...
  },
  {
    id: 'tokomove',
      ...
      lineage: 'Mini Metro',
      controls: 'vedä pysäkiltä toiselle: linja · vedä pään nupista: jatka · vedä takaisin: peru',
      note: 'v5 — toimii vihdoin puhelimessa: kartta kääntyy pystyyn ja säätimet mahtuvat ruudulle',
    },
    ja: {
      tagline: '駅はすべて図形で、待っている人はみな別の図形へ行きたい。路線を引き、列の伸びるところへ列車を回す — 終わりのない街で、あるいは時間制限のあるミッションで。',
      lineage: 'ミニメトロ',
      controls: '駅から駅へドラッグ：路線 · 端のつまみをドラッグ：延伸 · 戻すと取り消し',
      note: 'v5 — スマホでちゃんと遊べるように。盤面が縦向きになり、操作ボタンも画面に収まる。',
    },
    status: 'active',
    note: 'v5 — plays properly on a phone now: the board turns to portrait and the controls fit',
    title: 'Toko Move',
    ...
    controls: 'drag stop to stop: a line · drag the end stub: carry it on · drag back: undo',
    path: 'toko-move/',
    inRepo: true,

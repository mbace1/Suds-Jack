...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flowsnow.best', fmt: 'points' },
      ...
      note: 'v2 — lumipeite on nyt syvyyttä: lauta uppoaa ja nousee vauhdista pintaan, syvä puuteri hidastaa ja palkitsee, nokka voi upota',
    },
    ja: {
      ...
      note: 'v2 — 積雪が深さを持った：板は沈み、速度で浮き上がる。深雪は遅いが高得点、ノーズは刺さる',
    },
    pad: 'native',
    status: 'active',
    note: 'v2 — the snowpack has depth now: the board sinks in and planes back out with speed, deep powder is slow and pays, and the nose can dig',
    title: 'Flowsnow',

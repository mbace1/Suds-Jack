...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'v55 — tulvineen aseman vartiotorni tekee ampumisesta, väistämisestä ja energiakilvestä oikean taistelun',
    },
    ja: {
      tagline: '始めた動きは必ず終わる。ぶら下がり、よじ登り、相手より先に銃を抜く。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 歩く（長押しで走る）· ↑ ジャンプ／よじ登り · ↓ しゃがむ · E 銃 · X 撃つ',
      note: 'v55 — 浸水駅のセキュリティ砲塔に対し、射撃・しゃがみ回避・エネルギーシールドが実戦になる',
    },
    pad: 'native',
    status: 'active',
    note: 'v55 — a telegraphed security sentry makes shooting, crouch-dodging and the directional energy shield real combat',
    title: 'Flash Prince',
  ...
  },
  {
    id: 'turf',
      ...
      tagline: 'Ruudukkotaktiikkaa sateisella pohjoismaisella takapihalla: näet vihollisten aikeet etukäteen, suoja oikeasti merkitsee, kolme operaattoria vihollisjoukkoa vastaan.',
      ...
      note: 'v9 — parannettu kosketuslayoutin luettavuutta: lauta lähempänä ohjauspaneelia, kirkkaammat liike-/hyökkäysmerkinnät.',
    },
    ja: {
      tagline: '雨に濡れた北欧の裏路地でのグリッド戦術。敵の狙いは先に見える、遮蔽物が本当に効く、三人のオペレーターが敵の一団に立ち向かう。',
      lineage: 'Into the Breach × Metal Slug Tactics',
      controls: 'オペレーターをタップ、次にマスか敵をタップ · キーボード/パッドにも対応',
      note: 'v9 — 盤面を操作パネルに近づけ、移動/攻撃の表示をより見やすく改善。',
    },
    pad: 'native',
    status: 'active',
    note: 'v9 — mobile legibility pass: board sits against the control panel, move/attack highlights and enemy telegraphs are now clearly visible on a phone.',
    title: 'TURF',
    tagline: 'Grid tactics on rain-lit Nordic backlots: telegraphed hits, cover that actually matters, three operators against the block.',
    lineage: 'Into the Breach × Metal Slug Tactics',
  ...
  },
  {
    id: 'tokomove',
      ...
      lineage: 'Mini Metro',
      controls: 'vedä pysäkiltä toiselle: linja · vedä pään nupista: jatka · vedä takaisin: peru · autokentällä: vedä = tie, vedä takaisin = pois · bussikerroksella: reitti vain kadulle joka on jo olemassa',
      note: 'v13 — Kampanja on kaupunkeja: luku 1 on oikea Helsinki, kaikki ratikkalinjat ja pysäkit omilla nimillään.',
    },
    ja: {
      tagline: '駅はすべて図形で、待っている人はみな別の図形へ行きたい。路線を引き、列の伸びるところへ列車を回す — 終わりのない街で、あるいは時間制限のあるミッションで。',
      lineage: 'ミニメトロ',
      controls: '駅から駅へドラッグ：路線 · 端のつまみをドラッグ：延伸 · 戻すと取り消し · 車のレイヤー：ドラッグで道路、なぞり返すと撤去 · バスのレイヤー：街路のある所だけ路線を引ける',
      note: 'v13 — キャンペーンは都市：第1章は実在のヘルシンキ。全トラム路線と、本当の停留所名。',
    },
    status: 'active',
    note: 'v13 — The campaign is cities: chapter one is real Helsinki, every live tram service under the board and every stop under its own name',
    title: 'Toko Move',
    tagline: 'Every stop is a shape, and everyone waiting on one wants a different one. Draw the lines and put the trains where the queue is — across a campaign of real cities, starting in Helsinki.',
    lineage: 'Mini Metro',
    tags: ['puzzle', 'transit', 'endless'],
    controls: 'drag stop to stop: a line · drag the end stub: carry it on · drag back: undo · on the car layer: drag to lay road, drag back along it to lift · on the bus layer: draw a route, but only where a street runs · L or the layer button: switch which one you are drawing on',
    path: 'toko-move/',
    inRepo: true,

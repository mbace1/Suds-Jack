...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v8 — kolme työmaata: kaiva valli, nosta palkki, murra muuri. Ohjaimella tai kosketuksella.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v8 — 現場は三つ：土手を掘り、鉄骨を架け、壁を崩す。コントローラーでもタッチでも。',
    },
    pad: 'native',
    status: 'active',
    note: 'v8 — three sites: dig the bank, sling the girder, take the crane to the wall. Controller or touch.',
    title: 'Eeri',

...
export const GAMES = [
  ...
  },
  {
    id: 'slaykallio',
      ...
      note: 'v2 — silta penkin tilalle, karumpi ilme, kuva joka kortissa, ja rosterina Kallion pultsarit.',
    },
    ja: {
      tagline: 'カッリオの厚い板橋。厚紙とブリキの人形、ネズミ、変異する粘塊、そして計算式を書き換える相棒たち。',
      lineage: 'Slay the Spire 2 × Balatro',
      controls: 'カードをタップ、次に敵をタップ · 1-9／矢印／E · パッドとタッチ対応',
      note: 'v2 — ベンチを橋に、より荒れた絵づくり、全カードに絵、そして主役はカッリオの浮浪者たち。',
    },
    pad: 'native',
    status: 'active',
    note: 'v2 — a plank bridge instead of a bench, a grittier look, a picture on every card, and a roster of Kallio bums.',
    title: 'Slay Kallio',

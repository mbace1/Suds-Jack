...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.3 — Game Boy -ohjain pystyssä, arcade-paneeli vaakaan. Alkuruutu, ja napeissa kuvat siitä mitä ne tekevät.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.3 — 縦はゲームボーイ、横はアーケードパネル。タイトル画面と、動きの絵がついたボタン。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.3 — a Game Boy pad in portrait, an arcade panel in landscape. In Finnish, English and Japanese. A title screen, and buttons with pictures of what they do.',
    title: 'Eeri',

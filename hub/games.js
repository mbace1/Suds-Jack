...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'v60 — Courier säilyttää oman asunsa myös miekan vedossa ja taistelussa',
    },
    ja: {
      tagline: '始めた動きは必ず終わる。ぶら下がり、よじ登り、相手より先に銃を抜く。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 歩く（長押しで走る）· ↑ ジャンプ／よじ登り · ↓ しゃがむ · E 銃 · X 撃つ',
      note: 'v60 — Courierは剣を抜いて戦っても独自の衣装を保つ',
    },
    pad: 'native',
    status: 'active',
    note: 'v60 — the Courier keeps his own outfit while drawing and fighting with the sword',
    title: 'Flash Prince',

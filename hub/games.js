...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.38 — Eeristä tehdään Godot-käännöstä, ja käännös lukee nyt tiedostoa eikä tekstiä: spec/eeri.json sisältää hyppybudjetin, jokaisen vihollisen kellon ja kaikki kaksitoista kenttää ruutukarttoineen. Portti ei enää kopioi lukuja käsin.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.38 — Godot版はこのビルドの更新から作られる。移植が読むのは文章ではなくファイル──spec/eeri.json に跳躍の予算、敵ごとの時計、12面すべてのタイル格子が入る。数値を手で写す必要はもうない。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.38 — A Godot port is produced from this build, and it now reads a file instead of the prose: spec/eeri.json carries the jump budget, every enemy clock and all twelve levels including their tile grids. Prose is a fine way to say why a number changed and a terrible way to carry it.',
    title: 'Eeri',

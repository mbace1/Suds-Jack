...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'v59 — tulvakaupungissa liikkuvat kaukoliikenne, huoltonostin ja valojen rikkonaiset heijastukset',
    },
    ja: {
      tagline: '始めた動きは必ず終わる。ぶら下がり、よじ登り、相手より先に銃を抜く。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 歩く（長押しで走る）· ↑ ジャンプ／よじ登り · ↓ しゃがむ · E 銃 · X 撃つ',
      note: 'v59 — 浸水都市に遠方交通、稼働する保守ホイスト、光の揺れる反射を追加',
    },
    pad: 'native',
    status: 'active',
    note: 'v59 — distant transit, a working maintenance hoist and broken light reflections animate the flooded city',
    title: 'Flash Prince',

...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v3 — kaksi työmaata: kaiva valli pois, sitten nosta palkki ja laske se sillaksi',
    },
    ja: {
      ...
      note: 'v3 — 現場は二つ：土手を掘り崩し、次は鉄骨を吊って橋として据える',
    },
    pad: { keys: { left: 'KeyA', right: 'KeyD', up: 'KeyW', down: 'KeyS', a: 'Space', b: 'KeyE' } },
    status: 'active',
    note: 'v3 — two sites now: dig the bank away, then sling the girder and lower it in as a bridge',
    title: 'Eeri',

...
export const GAMES = [
  ...
  },
  {
    id: 'tokotrip',
      ...
      note: 'uutta: tyrsky hehkuu auringonlaskun jälkeen — napauta postikorttia sivupöydällä',
    },
    ja: {
      ...
      note: '新着：日没後、波打ち際が光る — サイドテーブルの絵はがきをタップ',
    },
    pad: 'native',
    vr: true,
    status: 'active',
    note: 'new: the surf glows after sunset — tap the postcard on the side table',
    title: 'Toko Trip',

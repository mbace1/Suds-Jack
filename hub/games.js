...
export const GAMES = [
  ...
  },
  {
    id: 'tinyhawk',
      ...
      controls: 'lataa oikea tatti ↓, vapauta tai napsauta ↑ · vasen tatti ohjaa · WASD + Väli',
      note: 'v3 — oikean tatin hyppy toimii nyt luotettavasti vapauttamalla tai napsauttamalla ylös',
    },
    ja: {
      tagline: 'ほぼ真っ暗な公園で撮るスケートパート。スティックを溜め、弾き、つなぎを切らさない。',
      lineage: 'Skate Story × Tony Hawk',
      controls: '右スティックを ↓ に溜め、離すか ↑ に弾く · 左スティックで舵 · WASD + スペース',
      note: 'v3 — 右スティックのオーリーが、離すか上へ弾く操作で確実に反応',
    },
    pad: 'native',
    status: 'active',
    note: 'v3 — right-stick ollies now fire reliably on release or a full upward flick',
    title: 'Tiny Hawk',
    ...
    controls: 'load right stick ↓, then release or flick ↑ · left stick steers · WASD + Space',
    path: 'tinyhawk/',
    inRepo: true,
    accent: '#8fe6d8',
    art: 'prism',

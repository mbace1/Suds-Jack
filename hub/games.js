...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.28 — maailmoilla 3 ja 4 on vihdoin omat työkoneensa: metsässä telaketjuinen kourakone, yösiirrossa pyöräkuormaaja jossa on valot mastossa. Kentän vaihto tapahtuu valot alhaalla, ja robotit ovat oikeita malleja.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.28 — ワールド3と4にようやく専用の重機。森はクローラー式のグラップル機、夜勤はマストに作業灯を積んだホイールローダー。ステージの切り替えは暗転してから、ロボットは実モデル。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.28 — worlds 3 and 4 finally have machines of their own: a tracked grapple skidder in the forest and a wheeled loader with work lamps on the night shift, instead of borrowing world 1\u2019s digger. A level change happens with the lights down — the picture fades, the next room is built in the dark, and the lights come up on a room that is finished.',
    title: 'Eeri',
  ...
  },
  {
    id: 'tokomove',
      ...
      tagline: 'Jokainen pysäkki on muoto, ja jokainen odottaja haluaa johonkin toiseen muotoon. Piirrä linjat, siirrä junat sinne missä jono kasvaa, ja pidä kaupunki liikkeessä niin kauan kuin pystyt.',
      lineage: 'Mini Metro',
      controls: 'vedä pysäkiltä toiselle: linja · vedä pään nupista: jatka · vedä takaisin: peru',
      note: 'v2 — rakennettu kokonaan uusiksi, oma moottori, ei mitään jaettua',
    },
    ja: {
      tagline: '駅はすべて図形で、待っている人はみな別の図形へ行きたい。路線を引き、列の伸びるところへ列車を回し、街が動かなくなるまで動かし続ける。',
      lineage: 'ミニメトロ',
      controls: '駅から駅へドラッグ：路線 · 端のつまみをドラッグ：延伸 · 戻すと取り消し',
      note: 'v2 — ゼロから作り直し。自前のエンジンで、共有部分なし',
    },
    status: 'active',
    note: 'v2 — rebuilt from scratch; its own engine, nothing shared',
    title: 'Toko Move',
    tagline: 'Every stop is a shape, and everyone waiting on one wants a different one. Draw the lines, put the trains where the queue is, and keep the city moving for as long as it can be kept moving.',
    lineage: 'Mini Metro',

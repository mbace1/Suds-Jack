...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.21 — kaikki neljä maailmaa maalattu ja 12 kenttää valikossa. Kahdeksan työkonetta ja yhdeksän uutta työmaakapinetta mallinnettu, ja Eeri osaa nyt seistä paikallaan uskottavasti: katselee ympärilleen, epäröi reunalla, kiipeää tikkaille.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.21 — 4つのワールドすべてに専用の背景、12ステージすべてがメニューに。重機8台と新しい現場道具9点をモデリング。待機中の仕草、崖際のためらい、はしごの乗り降りも追加。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.21 — all four worlds painted, all twelve levels in the pause menu, and the site loads about four times faster than it did. Eight worksite machines plus a nine-piece site kit are modelled now, and Eeri has something to do while you are not moving: idle breaks, a hesitation at the edge of a drop, a proper climb on and off a ladder.',
    title: 'Eeri',

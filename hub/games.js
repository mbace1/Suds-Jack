...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flowsnow.best', fmt: 'points' },
      ...
      note: 'v4 — lumella on muoto: aito auringon varjoraja, leivotut varjot joka kinoksesta, tuulen piirtämä pinta ja vuoret taivaanrannassa',
    },
    ja: {
      ...
      note: 'v4 — 雪に形がついた：太陽の明暗境界、うねりごとに焼き込まれた影、風が刻んだ雪面、そして地平線の山並み',
    },
    pad: 'native',
    status: 'active',
    note: 'v4 — the snow has form: a real sun terminator over the wrapped sky term, shadows baked off every swell, a wind-carved skin, and mountains on the horizon',
    title: 'Flowsnow',

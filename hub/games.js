...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.44 — Maailma 1 sai oman lavastuksensa: varoitusaita, materiaalipiha, telinekaari, hirsikehikko, ilmoitustaulu ja lavakasa — suoraan sen omasta materiaalikirjastosta.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.44 — ワールド1に専用の背景装飾が加わった——警告バリケード、資材置き場、足場、木組みの骨組み、看板、木箱の山。すべて自分のカタログから。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.44 — World 1 got its own dressing: a hazard barrier, a material yard, a scaffold bay, a gable frame, a billboard, a crate cluster — built off its own art catalog, same as world 2\u2019s pipe yard.',
    title: 'Eeri',

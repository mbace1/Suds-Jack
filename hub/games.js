...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.36 — Eeri ISTUU nyt koneessa eikä seiso sen päällä, tikkailla hän on puolat edessään eikä takanaan, ja etuala häipyy kun kiipeät. Kävely ja juoksu ovat eri liikkeitä, ja hyppy venyy ja litistyy niin että liikkeet erottuvat.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.36 — エエリは重機に「座る」ようになった（今までは立っていた）。はしごでは横木の手前に付き、登る間は手前の景色が薄くなる。歩きと走りが別の動きになり、ジャンプに伸び縮みがついて動作が読み取りやすい。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.36 — Eeri SITS in the machine now instead of standing on it, climbs on the near side of the ladder instead of behind it, and the foreground steps aside while you climb. Walking and running are different moves, jumps stretch and land squashed, and animations no longer get stuck mid-climb.',
    title: 'Eeri',

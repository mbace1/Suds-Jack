...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      controls: 'A D juokse · Väli hyppää · E kiipeä koneeseen · W S puomi · S kaivaa',
      note: 'v2 — kukaan ei aja konetta ennen sinua; kuoppa on pojan kokoinen, valli koneen',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: 'A D 走る · スペース ジャンプ · E 乗り込む · W S ブーム · S 掘る',
      note: 'v2 — 誰も運転していない重機。穴は子ども用、土手は機械用',
    },
    pad: { keys: { left: 'KeyA', right: 'KeyD', up: 'KeyW', down: 'KeyS', a: 'Space', b: 'KeyE' } },
    status: 'active',
    note: 'v2 — nobody is driving it until you are; the pit is kid-shaped, the bank is machine-shaped',
    title: 'Eeri',
    ...
    controls: 'A D run · Space jump · E climb in · W S boom · hold S to dig',
    path: 'eeri/',
    inRepo: true,
    accent: '#ffb01f',
    art: 'worksite',

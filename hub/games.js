...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'v67 — kolme erilaista vihollistyyppiä: säästettävä eläin, matalalta ampuva lennokki ja panssaroitu vartija',
    },
    ja: {
      tagline: '始めた動きは必ず終わる。ぶら下がり、よじ登り、相手より先に銃を抜く。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 歩く（長押しで走る）· ↑ ジャンプ／よじ登り · ↓ しゃがむ · E 銃 · X 撃つ',
      note: 'v67 — 見逃せる生物、低空射撃ドローン、装甲突進兵という三つの戦闘判断',
    },
    pad: 'native',
    status: 'active',
    note: 'v67 — spare wildlife, jump or reflect low drone fire, and shield-rush armored wardens to expose their cores',
    title: 'Flash Prince',

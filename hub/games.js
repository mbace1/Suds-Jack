...
export const GAMES = [
  ...
  },
  {
    id: 'turf',
      ...
      note: 'v19 — viisi taistelua, kokemuspisteet ja aseiden pudotukset, palavat ruudut ja porraskuilut sekä viholliset joilla on oma taistelutapa.',
    },
    ja: {
      tagline: '雨に濡れた北欧の裏路地でのグリッド戦術。敵の狙いは先に見え、遮蔽物が本当に効き、階段の吹き抜けへ突き飛ばす方が撃つより確実に倒せる。',
      lineage: 'Into the Breach × Metal Slug Tactics',
      controls: 'オペレーターをタップ、次にマスか敵をタップ · キーボード/パッドにも対応',
      note: 'v19 — 5つの戦闘、経験値と武器のドロップ、燃える床と吹き抜け、そしてそれぞれ独自の戦い方をする敵。',
    },
    pad: 'native',
    status: 'active',
    note: 'v19 — five encounters, XP and weapon drops, burning tiles and open stairwells, and enemies that each fight their own way.',
    title: 'TURF',

...
export const GAMES = [
  ...
  },
  {
    id: 'tokomove',
      ...
      note: 'päivän vuoro kaikille, viiden vuoron viikko varusteineen ja vuokrineen, ja LIVE: oikeat raitiovaunut ja metrot juuri nyt — tarkalla HSL-verkolla ja oikealla karttapohjalla',
    },
    ja: {
      ...
      note: '毎日の共通シフト、装備と家賃の5日間の週、そしてLIVE：今この瞬間の本物のトラムと地下鉄 — 正確なHSL網と実データの地図で',
    },
    status: 'active',
    live: true,
    note: 'a daily shift for everyone, a week of five with kit and rent due Friday, and LIVE: the real trams and metro, right now — on the exact HSL network and real ground data',
    title: 'Toko Move',

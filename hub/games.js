...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      tagline: 'Poika työmaalla: juokse, kiipeä, hyppää pienten koneiden päälle — ja välillä pääset ajamaan isoa.',
      lineage: 'Mario 3 × Yoshi’s Crafted World × Tonka',
      controls: '◀ ▶ juokse · Ⓐ hyppää · ▲ ▼ kiipeä · Ⓑ nouse koneeseen',
      note: 'v15 — kolme kenttää, jokainen yhdestä asiasta: hyppy päälle, kiipeäminen, molemmat. Kone odottaa reitillä, työ edessään.',
    },
    ja: {
      tagline: '工事現場の子ども。走り、はしごを登り、小さな機械を踏みつける — そして時々、大きいのに乗る。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · ▲ ▼ 登る · Ⓑ 乗り込む',
      note: 'v15 — 三つのステージ、それぞれ一つのアイデア：踏みつけ、はしご、その両方。機械は仕事のそばで待っている。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15 — three levels, one idea each: the stomp, the climb, then both and the crane. The machine waits on the route facing its job; a hundred bolts and three hidden golden ones per level.',
    title: 'Eeri',
    tagline: 'A kid on a worksite: run, climb, land on the small machines — and now and then, ride a big one.',
    lineage: 'Mario 3 × Yoshi’s Crafted World × Tonka',
    tags: ['platformer', 'three.js', 'diorama'],
    controls: '◀ ▶ run · Ⓐ jump · ▲ ▼ climb · Ⓑ climb into the machine',
    path: 'eeri/',
    inRepo: true,
    accent: '#ffb01f',
    art: 'worksite',

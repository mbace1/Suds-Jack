...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v6 — kolme työmaata, jokainen todistettu läpäistäväksi: kaiva valli, nosta palkki, murra muuri nosturilla',
    },
    ja: {
      ...
      note: 'v6 — 現場は三つ、すべて踏破可能と検証済み：土手を掘り、鉄骨を架け、クレーンで壁を崩す',
    },
    pad: { keys: { left: 'KeyA', right: 'KeyD', up: 'KeyW', down: 'KeyS', a: 'Space', b: 'KeyE' } },
    status: 'active',
    note: 'v6 — three sites, each proven finishable: dig the bank, sling the girder, then take the crane and knock the wall down',
    title: 'Eeri',
    ...
    controls: 'A D run · Space jump · E climb in · W S boom · hold S to dig, sling or swing',
    path: 'eeri/',
    inRepo: true,
    accent: '#ffb01f',
    art: 'worksite',

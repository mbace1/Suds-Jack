...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'hyperDaggerHi', fmt: 'secs' },
      ...
      tagline: 'Napauta haulikkoryöppy, pidä pohjassa tikarivirta ja käytä luukenttä REAP-iskuun neonlauman sulkeutuessa ympärillesi.',
    ...
    ja: {
      tagline: 'タップでショットガン、長押しでダガー連射。砕けた骨をREAPに変え、ネオンの群れを生き延びろ。',
      lineage: 'Devil Daggers × HYPERDEMON',
    ...
    status: 'active',
    title: 'Hyper Dagger',
    tagline: 'Tap for a shotgun burst, hold for a dagger stream, then REAP the bone-yard as the sculpted neon swarm closes in.',
    lineage: 'Devil Daggers × HYPERDEMON',

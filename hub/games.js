...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'v62 — matalat liikkeet osuvat lattiaan ja Courierin koko animaatiosarja näkyy galleriassa',
    },
    ja: {
      tagline: '始めた動きは必ず終わる。ぶら下がり、よじ登り、相手より先に銃を抜く。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 歩く（長押しで走る）· ↑ ジャンプ／よじ登り · ↓ しゃがむ · E 銃 · X 撃つ',
      note: 'v62 — 低い動作が床に正しく接地し、Courierの全アニメーションをギャラリーで確認可能',
    },
    pad: 'native',
    status: 'active',
    note: 'v62 — the Courier gallery covers every body and sword state; low actions meet the floor cleanly',
    title: 'Flash Prince',

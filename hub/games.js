...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.42 — Kiipeäminen ei enää tartu tikkaiden taakse ja etuala väistyy jo lähestyessä, ei vasta kiivetessä. Palkkipulma sai nuolimerkin kuin kaivuupuomi, ja juoksun koko ei enää eroa seisonnasta. Editori sai omat kerrokset ja työkalupalkin.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.42 — 梯子は近づいた時点で前景が透けるように、登った後だけでなく。桁の謎解きに矢印サインを追加。走行と静止でサイズが揃うよう修正。エディタに上部バーと左レイヤーパネルを追加。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.42 — The foreground fades approaching a ladder now, not just once already climbing. The girder wears a chevron sign like the dig obstacle does. Running and standing render at the same size. And the level editor got a top bar and a left-side layer rail.',
    title: 'Eeri',

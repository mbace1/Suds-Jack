...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.26 — maailmat 3 ja 4 saivat omat pulttipolkunsa: kaari jokaisen hypyn yli, pystyrivi siellä missä pitää nousta, ja pultteja sen takana minkä kone raivaa. Vaakatasossa kuva on 56% leveämpi ja Eerillä on ääriviiva.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.26 — ワールド3と4に専用のボルトの道筋。ジャンプの上には弧、登る場所には縦列、重機がどけた先にもボルト。横持ちの画面は56%広く、エエリには輪郭線。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.26 — worlds 3 and 4 lay their own bolt trails now: an arc over every jump, a column wherever the answer is up, and bolts waiting behind the thing the machine clears. Held sideways the picture is 56% wider — the drawn control board is gone and the buttons sit small and low over the game — and the kid has an outline so you can always find him.',
    title: 'Eeri',

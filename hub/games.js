...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'v54 — yhtenäinen toinen hahmo, vakaampi kiipeily sekä pistoolin energiakilpi',
    },
    ja: {
      tagline: '始めた動きは必ず終わる。ぶら下がり、よじ登り、相手より先に銃を抜く。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 歩く（長押しで走る）· ↑ ジャンプ／よじ登り · ↓ しゃがむ · E 銃 · X 撃つ',
      note: 'v54 — 統一された第2キャラクター、安定した登攀、ピストル用エネルギーシールド',
    },
    pad: 'native',
    status: 'active',
    note: 'v54 — full second character set, stable low climbs and mantles, pistol tracer and rechargeable energy shield',
    title: 'Flash Prince',

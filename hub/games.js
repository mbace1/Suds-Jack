...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'v58 — laskeutuminen näyttää koko liikkeen ja roikkumisesta kiipeäminen ei enää nytkähdä',
    },
    ja: {
      tagline: '始めた動きは必ず終わる。ぶら下がり、よじ登り、相手より先に銃を抜く。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 歩く（長押しで走る）· ↑ ジャンプ／よじ登り · ↓ しゃがむ · E 銃 · X 撃つ',
      note: 'v58 — 着地の全フレームを再生し、ぶら下がりから登る際のポーズ飛びを解消',
    },
    pad: 'native',
    status: 'active',
    note: 'v58 — landings now finish their full animation and hang-to-mantle transitions no longer pop',
    title: 'Flash Prince',

...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flowsnow.best', fmt: 'points' },
      ...
      tagline: 'Yksinkertainen lumilautapeli: yksi lasku aamunkoitosta hämärään, kaarteet virtauksena ja lumi oikeana simulaationa.',
      lineage: 'Journey × Sword of the Sea × Shredders',
      controls: '← → kallista · ↑ kyyry · ↓ jarruta · Väli ponnista · Z grab · kosketus ja ohjain toimivat',
      note: 'v1 — ensimmäinen lasku: kanttimalli, hiukkaslumi, kaulahuivi ja vuorokaudenaika laskun mukaan',
    },
    ja: {
      tagline: 'シンプルなスノーボード。夜明けから夕暮れまでの一本の滑走、カービングがフローになり、雪は本物の粒子シミュレーション。',
      lineage: 'Journey × Sword of the Sea × Shredders',
      controls: '← → 傾ける · ↑ タック · ↓ ブレーキ · スペース ジャンプ · Z グラブ · タッチ／パッド対応',
      note: 'v1 — 最初の滑走：エッジの物理、粒子の雪、なびくスカーフ、滑るほど移ろう時刻',
    },
    pad: 'native',
    status: 'active',
    note: 'v1 — first descent: an edge model, particle snow, a live scarf, and an hour that turns with the run',
    title: 'Flowsnow',
    tagline: 'A simplistic snowboarding game: one run from dawn to dusk, carves that become flow, and snow that is a real particle simulation.',
    lineage: 'Journey × Sword of the Sea × Shredders',
    tags: ['snowboard', 'three.js', 'zen'],
    controls: '← → lean · ↑ tuck · ↓ brake · Space pop · Z grab · touch and pad supported',
    path: 'flowsnow/',
    inRepo: true,
    accent: '#f4a27a',
    art: 'flowsnow',
  },
  {
    ...
    score: { key: 'powderBest', fmt: 'points' },
      ...
      tagline: 'Kaksi kelkkaa: nokkaraketit vetävät sinut kaarteen läpi, peräraketit heittävät perän ulos. Oikea tatti on painosi — taakse noste ja boosti, eteen keulapainatus.',
      lineage: 'lumilautatuntuma × scifi-formula × PS2',
      controls: 'Vasen tatti ohjaus + kaasu · oikea tatti kamera + paino · F vaihtaa rungon',
    },
    ja: {
      tagline: '2種のそり：機首ロケットはコーナーへ引き込み、後部ロケットはテールを流す。右スティックは体重 — 引けばノーズが上がりブースト、押せば前輪加重。',
      lineage: 'スノーボード感 × SFフォーミュラ × PS2',
      controls: '左スティック ステア+スロットル · 右スティック カメラ+体重 · F シャシー切替',
    },
    status: 'active',
    note: 'v5 — the weight axis and two chassis, both measured; still tuned from telemetry rather than felt',
    title: 'Powder',
    tagline: 'Two sleds: nose rockets pull you through the corner, aft rockets step the tail out. The right stick is your weight — back to lift the nose and boost, forward to press it down and bite.',
    lineage: 'snowboard feel × sci-fi formula × PS2',
    tags: ['racing', 'sim', 'three.js'],
    controls: 'Left stick steer + throttle · right stick camera + weight · F swaps chassis',
    path: 'powder/',
    inRepo: true,
    accent: '#c8a0e8',
    art: 'powder',

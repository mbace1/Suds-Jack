...
export const GAMES = [
  ...
  },
  {
    id: 'turf',
      ...
      note: 'v7 — kaksiosainen taisteluketju, kokemuspisteet ja aseryöstöt taistelujen välissä, näppäimistö- ja ohjaintuki.',
    },
    ja: {
      tagline: '雨に濡れた北欧の裏路地でのグリッド戦術。敵の狙いは先に見える、遮蔽物が本当に効く、三人のオペレーターが敵の一団に立ち向かう。',
      lineage: 'Into the Breach × Metal Slug Tactics',
      controls: 'オペレーターをタップ、次にマスか敵をタップ · キーボード/パッドにも対応',
      note: 'v7 — 経験値と武器ドロップのある二連戦、キーボードとパッド対応。',
    },
    pad: 'native',
    status: 'active',
    note: 'v7 — a two-encounter run with XP/leveling and weapon-swap loot drops, keyboard and gamepad supported.',
    title: 'TURF',

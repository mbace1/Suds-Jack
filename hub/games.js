...
export const GAMES = [
  ...
  },
  {
    id: 'tokomove',
      ...
      note: 'v1 — rakennettu kokonaan uusiksi, oma moottori, ei mitään jaettua',
    },
    ja: {
      tagline: '駅はすべて図形で、待っている人はみな別の図形へ行きたい。路線を引き、列の伸びるところへ列車を回し、街が動かなくなるまで動かし続ける。',
      lineage: 'ミニメトロ',
      controls: '駅から駅へドラッグ：路線 · 端のつまみをドラッグ：延伸 · 戻すと取り消し',
      note: 'v1 — ゼロから作り直し。自前のエンジンで、共有部分なし',
    },
    status: 'active',
    note: 'v1 — rebuilt from scratch; its own engine, nothing shared',
    title: 'Toko Move',

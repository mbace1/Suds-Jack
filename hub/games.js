...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'sudsJack.horizon.best', fmt: 'points' },
      ...
      note: 'v6 — Toko pöydässä: tarra (tai TOKO-nappi kosketusnäytöllä) avaa hänet pelin päälle ja pysäyttää ajon',
    },
    ja: {
      tagline: '9レーンのベクタースコアアタック。オーブをつなぎ、クローラーを踏み、地平線を読む。',
      controls: '← → / A D 移動 · スペース ジャンプ · パッド／タッチ対応',
      note: 'v6 — Tokoが卓に：ステッカー（タッチ画面ではTOKOボタン）でプレイを止めたまま話せる',
    },
    pad: 'native',
    status: 'active',
    note: 'v6 — Toko at the table: the sticker (TOKO on a touchscreen) opens him over the run and holds it',
    title: 'Suds Jack',
  ...
  },
  {
    id: 'tokomove',
      ...
      note: 'UUTTA: Kruunusillat — raitiovaunut 11 ja 12, Kruunuvuori ja Laajasalo kartalla. Viisi testattavaa asiaa aloitusruudulla. Päivän vuoro, viiden vuoron viikko ja vuokra, tarkalla HSL-verkolla',
    },
    ja: {
      ...
      note: '新着：クルーヌ橋 — 11番・12番トラム、クルーヌヴオリとラーヤサロが地図に。タイトル画面に試してほしいことが5つ。毎日のシフト、家賃の5日間の週、正確なHSL網で',
    },
    status: 'active',
    live: true,
    note: 'NEW: the Crown Bridges — trams 11 and 12, Kruunuvuori and Laajasalo are on the map. Five things to test on the title card. A daily shift, a week with rent due Friday, on the exact HSL network',
    title: 'Toko Move',
  ...
  },
  {
    ...
    score: { key: 'flowsnow.best', fmt: 'points' },
      ...
      note: 'v5 — laskulla on nyt viisi lukua: avoin kulho, uoma, kapea kouru, halkeamien viiltämä jäätikkö ja lopuksi laskun syvin puuteri',
    },
    ja: {
      ...
      note: 'v5 — 一本の滑走が五つの章になった：開けたボウル、ガリー、狭いクーロワール、クレバスの刻まれた氷河、そして最後に最も深いパウダー',
    },
    pad: 'native',
    status: 'active',
    note: 'v5 — the run has five chapters now: an open bowl, the gully, a couloir that closes in, a glacier cut by crevasses, and the deepest snow of the run at the bottom',
    title: 'Flowsnow',
  ...
  },
  {
    id: 'slaykallio',
      ...
      note: 'v39 — omistajan omat 26 hahmoa ovat nyt koko miehistö, irtileikattuina sillalla. Toinen näytös sai keskikohdan, vaikeusasteikko kuusi porrasta, ja vanhan nyrkkeilijän piikit kasvavat joka iskusta jonka ne torjuvat.',
    },
    ja: {
      tagline: 'カッリオの厚い板橋。厚紙とブリキの人形、ネズミ、変異する粘塊、そして計算式を書き換える相棒たち。',
      lineage: 'Slay the Spire 2 × Balatro',
      controls: 'カードをタップ、次に敵をタップ · 1-9／矢印／E · パッドとタッチ対応',
      note: 'v39 — オーナー自身の26人がそのまま配役になり、切り抜きとして橋に立つ。第二幕に中盤ができ、難度は六段、そして老ボクサーの棘は受けた一撃ごとに伸びる。',
    },
    pad: 'native',
    status: 'active',
    note: 'v39 — the owner\u2019s own 26 are the cast now, cut out and standing on the bridge. Act two grew a middle, a six-rung ascension ladder runs under every character, and the Old Boxer\u2019s thorns grow on the blow they answer.',
    title: 'Slay Kallio',
  ...
  },
  {
    id: 'piritori',
      ...
      note: 'Act I v4.54 — katso ennen kuin lähdet: Aatami kulkee itse kartalla · fi/en/ja',
    },
    ja: {
      ...
      note: 'Act I v4.54 — 見るだけでは動かない：アータミは自分で歩いて移動する · fi/en/ja',
    },
    status: 'active',
    note: 'Act I v4.54 — look before you go: tapping the map only inspects, and Aatami travels himself',
    title: 'Piritori → Eden',

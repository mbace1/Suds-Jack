...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'kahden tikun Conrad-liiketutkielma: sama hahmo jatkuu nyt juoksusta hyppyyn; hyväksytty rytmi ja nopeus säilyvät · klassinen / 4×',
    },
    ja: {
      tagline: '一つひとつの動きを作り直しているシネマティック・プラットフォーマー。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '左スティックで走る · 右スティック↑／押し込みでジャンプ · キーボード ← → + ↑／スペース',
      note: 'ツインスティック式Conrad動作テスト：走行からジャンプまで同じキャラクターに統一。承認済みのリズムと速度は維持 · クラシック／4×表示',
    },
    pad: 'native',
    status: 'active',
    note: 'twin-stick Conrad-motion study: one character now carries through run and jump; approved cadence and speed retained · Classic / 4×',
    title: 'Flash Prince',

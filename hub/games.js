...
export const GAMES = [
  ...
  },
  {
    id: 'tokomove',
      ...
      note: 'v11 — Vaihto: kaksi kerrosta yhtä aikaa, ja lasti kulkee tiellä pakettiautossa jonka erottaa liikenteestä.',
    },
    ja: {
      ...
      note: 'v11 — ハンドオーバー：2つのレイヤーが同時に動き、荷物は道路ではバンで運ばれ、他の車と見分けがつく。',
    },
    status: 'active',
    note: 'v11 — The Handover: two layers running at once, and the load rides a van you can pick out of traffic',
    title: 'Toko Move',
    ...
    controls: 'drag stop to stop: a line · drag the end stub: carry it on · drag back: undo · on the car layer: drag to lay road, drag back along it to lift · L or the layer button: switch which one you are drawing on',
    path: 'toko-move/',
    inRepo: true,

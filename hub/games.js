...
export const GAMES = [
  ...
  },
  {
    id: 'slaykallio',
      ...
      note: 'v26 — TURF:n hahmot liikkuvat nyt: piirretty ruutu vaihtuu iskun mukana. Kuusi uutta tyyppiä sillalle, ja kaksi joka reagoi siihen mitä teet.',
    },
    ja: {
      tagline: 'カッリオの厚い板橋。厚紙とブリキの人形、ネズミ、変異する粘塊、そして計算式を書き換える相棒たち。',
      lineage: 'Slay the Spire 2 × Balatro',
      controls: 'カードをタップ、次に敵をタップ · 1-9／矢印／E · パッドとタッチ対応',
      note: 'v26 — TURFの人形が動く。攻撃に合わせて絵そのものが差し替わる。橋に新顔が六人、うち二人はこちらの状態に反応する。',
    },
    pad: 'native',
    status: 'active',
    note: 'v26 — the figures ACT now: TURF\u2019s own seven-pose set drives the drawing, so a lunge winds up and commits instead of tilting. Six new people off the spare plates, two of whom read the fight before they swing.',
    title: 'Slay Kallio',

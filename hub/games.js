...
export const GAMES = [
  ...
  },
  {
    id: 'tokomove',
      ...
      note: 'päivän vuoro kaikille ja viiden vuoron viikko, varusteet vuorojen välissä ja vuokra perjantaina — tarkalla HSL-verkolla ja oikealla karttapohjalla',
    },
    ja: {
      ...
      note: '毎日の共通シフトと、シフトの合間に装備を選び金曜に家賃を払う5日間の週 — 正確なHSL網と実データの地図で',
    },
    status: 'active',
    live: true,
    note: 'a daily shift for everyone, and a week of five with kit between shifts and rent due Friday — on the exact HSL network and real ground data',
    title: 'Toko Move',

...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'hyperDaggerHi', fmt: 'secs' },
      ...
      tagline: 'Näe koko taistelu pallomaisessa areenanäkymässä: takana olevat viholliset näkyvät oikeina siluetteina, kun veistetyt uhat sulkeutuvat ympärillesi.',
    ...
    ja: {
      tagline: '球面アリーナ視界で戦場全体を捉え、背後の敵も実体のあるシルエットとして映る。造形された脅威の包囲を生き延びろ。',
      lineage: 'Devil Daggers × HYPERDEMON',
    ...
    status: 'active',
    title: 'Hyper Dagger',
    tagline: 'See the whole fight through a spherical arena view: rear enemies appear as real silhouettes while fully sculpted threats close in from every direction.',
    lineage: 'Devil Daggers × HYPERDEMON',

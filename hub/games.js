...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'hyperDaggerHi', fmt: 'secs' },
      ...
      tagline: 'Taisteluun reagoiva pallonäkymä avautuu kohti 180 astetta, takauhat palavat punaisina hologrammeina ja jokainen syöksy sekä tikari hajottaa areenan liikkeeksi ja väreiksi.',
    ...
    ja: {
      tagline: '戦闘に反応する球面視界が180度へ開き、背後の脅威は赤いホログラムとなる。ダッシュと短剣がアリーナを光と色へ砕く。',
      lineage: 'Devil Daggers × HYPERDEMON',
    ...
    status: 'active',
    title: 'Hyper Dagger',
    tagline: 'A combat-reactive spherical view opens toward 180°, rear threats burn as red holograms, and every dash and dagger fractures the arena into motion and colour.',
    lineage: 'Devil Daggers × HYPERDEMON',

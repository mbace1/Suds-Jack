...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'hyperDaggerHi', fmt: 'secs' },
      ...
      tagline: 'Devil Daggersista inspiroitunut riisuttu areena-FPS: karkea ohjelmistorasteri, rosoinen musta lattia, leveäsarviset luudemonit ja nelisorminen taikatikari.',
      lineage: 'Devil Daggers',
      controls: 'WASD + hiiri · LMB napauta/pidä ampuaksesi · Väli ×2 hyppy · Vaihto syöksy · R/E REAP · Esc tauko',
    },
    ja: {
      tagline: 'Devil Daggersに着想を得た簡潔なアリーナFPS。低解像度のソフトウェア風描画、荒い黒床、横に広い角付き骸骨、四本指の魔法短剣。',
      lineage: 'Devil Daggers',
      controls: 'WASD + マウス · 左クリック タップ/長押し 射撃 · スペース ×2 ジャンプ · Shift ダッシュ · R/E REAP · Esc 一時停止',
    },
    pad: 'native',
    status: 'active',
    title: 'Hyper Dagger',
    tagline: 'A stripped-down arena FPS inspired by Devil Daggers: coarse software raster, a rough black floor, wide horned skulls, and a four-finger magic dagger.',
    lineage: 'Devil Daggers',
    tags: ['fps', 'three.js', 'gamepad'],
    controls: 'WASD + mouse · tap/hold LMB fire · Space ×2 jump · Shift dash · R/E reap · Esc pause',
    path: 'hyperdagger/',
    inRepo: true,
    accent: '#d8412f',
    art: 'skull',

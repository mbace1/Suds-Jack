...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.27 — kentän vaihto tapahtuu nyt valot alhaalla: kuva häivytetään, uusi kenttä rakennetaan pimeässä ja valot nousevat valmiiseen huoneeseen. Robotit ovat oikeita malleja, ja lähimmät kerrokset on piirretty tarkemmiksi.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.27 — ステージの切り替えは暗転してから。暗いうちに次の部屋を組み立て、出来上がってから明ける。ロボットは実モデルになり、手前のレイヤーは解像度が上がった。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.27 — a level change happens with the lights down now: the picture fades, the next room is built in the dark, and the lights come up on a room that is finished — so the end of a level reads as an ending instead of a glitch. The small robots are real models rather than boxes, and the near layers are drawn at twice the resolution.',
    title: 'Eeri',

...
export const GAMES = [
  ...
  },
  {
    id: 'tokomove',
      ...
      note: 'v12 — Bussikerros: piirrä reitit kaduille jotka itse latoit. Bussi jumittaa samassa ruuhkassa jolle teit tilaa.',
    },
    ja: {
      ...
      note: 'v12 — バス路線レイヤー：自分で敷いた街路の上に路線を引く。バスは車のために空けたその道で渋滞にはまる。',
    },
    status: 'active',
    note: 'v12 — The bus layer: draw routes along the streets you laid, and watch them crawl in the traffic you made room for',
    title: 'Toko Move',

...
export const GAMES = [
  ...
  },
  {
    id: 'tokomove',
      ...
      note: 'v3 — tehtävät: loputon kaupunki ja festivaali joka päättyy keskiyöllä',
    },
    ja: {
      ...
      note: 'v3 — ミッション登場。終わりのない街と、真夜中に終わる祭りの夜。',
    },
    status: 'active',
    note: 'v3 — missions arrive: the endless city, and a festival that turns out at midnight',
    title: 'Toko Move',

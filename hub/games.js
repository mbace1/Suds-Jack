...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'hyperDaggerHi', fmt: 'secs' },
      ...
      tagline: 'Napauta haulikkoryöppy, pidä pohjassa tikarivirta ja käytä REAP-iskua uudessa rituaaliareenassa — 3D-viholliset ja näkökentän ulkopuolinen uhka ympäröivät sinut.',
    ...
    ja: {
      tagline: 'タップでショットガン、長押しでダガー連射。新しい儀式アリーナでREAPを放ち、立体化した敵と視界外の脅威を生き延びろ。',
      lineage: 'Devil Daggers × HYPERDEMON',
    ...
    status: 'active',
    title: 'Hyper Dagger',
    tagline: 'Tap for a shotgun burst, hold for a dagger stream, then REAP through a rebuilt ritual arena as fully sculpted threats close in from every direction.',
    lineage: 'Devil Daggers × HYPERDEMON',
  ...
  },
  {
    id: 'tinyhawk',
      ...
      controls: 'oikea tatti ↓ + ↖ potkuflippi · ↗ kantaflippi · sivulle pop shuvit · vapauta/↑ ollie',
      note: 'v5 — pysyvä pelihahmo on nyt pullea lintu täydellä skeittilaudalla ja siipianimaatioilla',
    },
    ja: {
      tagline: '丸々とした鳥が、ほぼ真っ暗な公園でスケートパートを撮る。スティックを溜め、弾き、つなぎを切らさない。',
      lineage: 'Skate Story × Tony Hawk',
      controls: '右スティック ↓＋↖ キックフリップ · ↗ ヒールフリップ · 横でポップショービット · 離す/↑ オーリー',
      note: 'v5 — 完整なスケートボードと翼アニメーションを備えた丸い鳥が主人公になった',
    },
    pad: 'native',
    status: 'active',
    note: 'v5 — the permanent protagonist is now a fat bird with a complete skateboard and animated wings',
    title: 'Tiny Hawk',
    ...
    controls: 'right stick ↓ + ↖ kickflip · ↗ heelflip · side swipe shuvit · release/↑ ollie',
    path: 'tinyhawk/',
    inRepo: true,
    accent: '#8fe6d8',
    art: 'prism',

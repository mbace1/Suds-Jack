...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'v63 — kaksi uutta bio-laitoksen aluetta, kilven torjunta, konelöydöt ja tarkka 4×-tila',
    },
    ja: {
      tagline: '始めた動きは必ず終わる。ぶら下がり、よじ登り、相手より先に銃を抜く。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 歩く（長押しで走る）· ↑ ジャンプ／よじ登り · ↓ しゃがむ · E 銃 · X 撃つ',
      note: 'v63 — バイオ施設の新エリア2面、シールド反射、機械部品、正確な4倍表示',
    },
    pad: 'native',
    status: 'active',
    note: 'v63 — two bio-facility screens, timed shield reflection, machine loot and exact 4× display',
    title: 'Flash Prince',

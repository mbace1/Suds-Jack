...
export const GAMES = [
  ...
  },
  {
    id: 'tokomove',
      ...
      note: 'v9 — säännöt saa nyt näkyviin kesken pelin, ja vesi varoittaa ennen kuin se estää.',
    },
    ja: {
      ...
      note: 'v9 — 遊びながらルールを開けるようになった。水は拒む前に知らせてくれる。',
    },
    status: 'active',
    note: 'v9 — the rules are reachable in play now, and the water warns you before it refuses you',
    title: 'Toko Move',

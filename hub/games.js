...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.35 — kaivinkone kaivaa nyt oikeasti: pidä nappia ja kauha käy kuopassa, penger tärisee kun siihen voi tarttua, ja kolmen rivin penger menee alle puolessatoista sekunnissa. Joka maailmasta löytyy myös yksi piirustus.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.35 — ショベルがちゃんと掘る。ボタンを押している間バケットが土をすくい、掘れる土手は浮いて知らせる。3段の土手が1.5秒足らずで崩れる。各ワールドに設計図が1枚。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.35 — the excavator actually digs now: hold the verb and the bucket strokes through the cut, the bank lifts and breathes when you are close enough to dig it, and a three-row bank comes down in under a second and a half instead of two seconds of a still arm. Every world also hides one blueprint to find.',
    title: 'Eeri',

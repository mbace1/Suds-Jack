...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'kahden tikun Conrad-liiketutkielma: hyväksytty 20 kuvan juoksu on palautettu ja lukittu; erilliset käännökset ja hypyt säilyvät · klassinen / 4×',
    },
    ja: {
      tagline: '一つひとつの動きを作り直しているシネマティック・プラットフォーマー。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '左スティックで走る · 右スティック↑／押し込みでジャンプ · キーボード ← → + ↑／スペース',
      note: 'ツインスティック式Conrad動作テスト：承認済み20フレーム走行を復元・固定。専用ターンとジャンプは維持 · クラシック／4×表示',
    },
    pad: 'native',
    status: 'active',
    note: 'twin-stick Conrad-motion study: approved 20-frame run restored and locked; dedicated turns and jumps retained · Classic / 4×',
    title: 'Flash Prince',

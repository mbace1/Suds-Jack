...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'kahden tikun Conrad-liiketutkielma: uusi 20 kuvan juoksu sekä omat paikaltaan ja vauhdista tehdyt hypyt · klassinen / 4×',
    },
    ja: {
      tagline: '一つひとつの動きを作り直しているシネマティック・プラットフォーマー。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '左スティックで走る · 右スティック↑／押し込みでジャンプ · キーボード ← → + ↑／スペース',
      note: 'ツインスティック式Conrad動作テスト：新20フレーム走行、立ち／走り専用ジャンプ · クラシック／4×表示',
    },
    pad: 'native',
    status: 'active',
    note: 'twin-stick Conrad-motion study: rebuilt 20-frame run plus dedicated standing and running jumps · Classic / 4×',
    title: 'Flash Prince',

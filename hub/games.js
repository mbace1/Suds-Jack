...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'hyperDaggerHi', fmt: 'secs' },
      ...
      tagline: 'Riisuttu selviytymis-FPS: vakaa etunäkymä, veistetyt vokseliviholliset, selkeä ruudukkoareena ja hillityt osumaefektit.',
    ...
    ja: {
      tagline: '安定した前方視界、造形されたボクセル敵、鮮明なグリッドアリーナ、抑えた衝撃表現に絞ったサバイバルFPS。',
      lineage: 'Devil Daggers × HYPERDEMON',
    ...
    status: 'active',
    title: 'Hyper Dagger',
    tagline: 'A stripped-back survival FPS with a stable forward view, sculpted voxel enemies, a crisp grid arena, and restrained impact effects.',
    lineage: 'Devil Daggers × HYPERDEMON',

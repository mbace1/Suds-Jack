...
export const GAMES = [
  ...
  },
  {
    id: 'tokomove',
      ...
      note: 'v7 — Ruuhka: uusi autokerros. Sinä lasket vain tien, kuljettajat valitsevat reittinsä itse.',
    },
    ja: {
      ...
      note: 'v7 — ラッシュ：新しい車のレイヤー。敷けるのは道路だけ、運転手は自分で道を選ぶ。',
    },
    status: 'active',
    note: 'v7 — The Rush: a car layer where you lay road and nothing else, and every driver picks their own way',
    title: 'Toko Move',

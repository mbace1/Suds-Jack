...
export const GAMES = [
  ...
  },
  {
    id: 'slaykallio',
      ...
      note: 'v45 — reitti luettuna: loppuruutu piirtää jokaisen kohtaamisen, mitä kukin maksoi ja mikä lopulta kaatoi — ja miten pakka terävöityi matkalla. Useimmat läpipeluut häviävät; nyt häviö kannattaa lukea.',
    },
    ja: {
      tagline: 'カッリオの厚い板橋。厚紙とブリキの人形、ネズミ、変異する粘塊、そして計算式を書き換える相棒たち。',
      lineage: 'Slay the Spire 2 × Balatro',
      controls: 'カードをタップ、次に敵をタップ · 1-9／矢印／E · パッドとタッチ対応',
      note: 'v45 — 道のりを読み返す。結果画面が歩いた戦いすべてと、その代償、そして最後に倒れた一戦を描く。山札がどう研ぎ澄まされたかも。負けの多いゲームだが、その負けが読めるようになった。',
    },
    pad: 'native',
    status: 'active',
    note: 'v45 — the run, read back: the end screen now draws every span you walked, what each cost you and which one finished you, plus how your deck sharpened on the way. Most runs lose; now a loss is worth reading.',
    title: 'Slay Kallio',

...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.32 — maa vastaa nyt maailmaansa: metsässä turvetta ja juuria, yösiirrossa kylmää savea. Latvusto ei ole enää rivi ympyröitä. Maailmoilla 3 ja 4 on omat työkoneensa, ja pystyasennossa vihje ei enää peitä peliä.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.32 — 地面がワールドごとに変わる。森は泥炭と根、夜勤は冷たい粘土。樹冠はもう円の並びではない。ワールド3と4には専用の重機、横持ちのヒント表示が画面を覆う不具合も解消。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.32 — the ground answers the world it is in: peat and roots in the forest, cold clay on the night shift, instead of one brown band under all four. The canopy stopped being a row of circles. Worlds 3 and 4 have machines of their own, and the hint line no longer covers the game when you hold the phone sideways.',
    title: 'Eeri',

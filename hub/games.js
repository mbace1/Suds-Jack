...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'v56 — hypyt laskeutuvat tarkasti ja kiipeäminen säilyttää valitun pistooliasennon',
    },
    ja: {
      tagline: '始めた動きは必ず終わる。ぶら下がり、よじ登り、相手より先に銃を抜く。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 歩く（長押しで走る）· ↑ ジャンプ／よじ登り · ↓ しゃがむ · E 銃 · X 撃つ',
      note: 'v56 — 着地位置を正確に固定し、登攀後も選択したピストル姿勢を維持',
    },
    pad: 'native',
    status: 'active',
    note: 'v56 — exact jump landings and clean low-climb/mantle transitions with the selected pistol preserved',
    title: 'Flash Prince',

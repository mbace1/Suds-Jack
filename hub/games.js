...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'hyperDaggerHi', fmt: 'secs' },
      ...
      tagline: 'Devil Daggersista inspiroitunut riisuttu areena-FPS: tumma käsi neljine hehkuvine tikareineen, pelkkään aikaan riisuttu HUD, liikevoima ja leveäsarviset kallot.',
      lineage: 'Devil Daggers',
      controls: 'WASD + hiiri · LMB napauta/pidä ampuaksesi · Väli hyppy · ampumapurkaus alas = tikarihyppy · Vaihto syöksy · R/E REAP · Esc tauko',
    },
    ja: {
      tagline: 'Devil Daggersに着想を得た簡潔なアリーナFPS。4本の燃えるダガーを構える黒い手、タイマーだけのサバイバルHUD、慣性を活かす移動、横に広い角付き骸骨。',
      lineage: 'Devil Daggers',
      controls: 'WASD + マウス · 左クリック タップ/長押し 射撃 · スペース ジャンプ · 下向きバーストでダガージャンプ · Shift ダッシュ · R/E REAP · Esc 一時停止',
    },
    pad: 'native',
    status: 'active',
    title: 'Hyper Dagger',
    tagline: 'A stripped-down arena FPS inspired by Devil Daggers: a dark four-dagger hand, a timer-only survival HUD, momentum movement, and wide horned skulls.',
    lineage: 'Devil Daggers',
    tags: ['fps', 'three.js', 'gamepad'],
    controls: 'WASD + mouse · tap/hold LMB fire · Space hop · burst downward for dagger jump · Shift dash · R/E reap · Esc pause',
    path: 'hyperdagger/',
    inRepo: true,
    accent: '#d8412f',
    art: 'skull',
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      tagline: 'Elokuvallinen tasohyppelypeli rakennetaan uudelleen liike kerrallaan.',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: 'Vasen tikku juoksee · oikea tikku ↑ / painallus hyppää · näppäimistö ← → + ↑ / Väli',
      note: 'kahden tikun Conrad-liiketutkielma: v23-hahmokorvaus poistettu ja v18-juoksu palautettu täsmälleen; hyppy rakennetaan seuraavaksi · klassinen / 4×',
    },
    ja: {
      tagline: '一つひとつの動きを作り直しているシネマティック・プラットフォーマー。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '左スティックで走る · 右スティック↑／押し込みでジャンプ · キーボード ← → + ↑／スペース',
      note: 'ツインスティック式Conrad動作テスト：不評だったv23の置換を削除し、v18走行を完全復元。次はジャンプを再構築 · クラシック／4×表示',
    },
    pad: 'native',
    status: 'active',
    note: 'twin-stick Conrad-motion study: rejected v23 character removed; exact v18 run restored; jump rebuild is next · Classic / 4×',
    title: 'Flash Prince',
    tagline: 'A cinematic platformer being rebuilt one committed movement at a time.',
    lineage: 'Another World × Flashback × Prince of Persia',
    tags: ['cinematic', 'raster', 'canvas'],
    controls: 'Left stick run · right stick ↑ / press jump · keyboard ← → + ↑ / Space',
    path: 'flashprince/',
    inRepo: true,
    accent: '#c8ee5a',
    art: 'ledge',

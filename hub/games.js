...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'v65 — konelöydöt käynnistävät laitoksen ja avautuva huoltoalusta kuljettaa kuilun yli',
    },
    ja: {
      tagline: '始めた動きは必ず終わる。ぶら下がり、よじ登り、相手より先に銃を抜く。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 歩く（長押しで走る）· ↑ ジャンプ／よじ登り · ↓ しゃがむ · E 銃 · X 撃つ',
      note: 'v65 — 機械部品で施設を起動し、動く保守フェリーで栽培シャフトを渡る',
    },
    pad: 'native',
    status: 'active',
    note: 'v65 — machine loot powers the facility and unlocks a rideable service ferry across the cultivation shaft',
    title: 'Flash Prince',

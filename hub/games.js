...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'v57 — matala kiipeäminen ja tavaroiden poiminta on nyt animoitu, ja tulvakaupungissa näkyy lisää elämää',
    },
    ja: {
      tagline: '始めた動きは必ず終わる。ぶら下がり、よじ登り、相手より先に銃を抜く。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 歩く（長押しで走る）· ↑ ジャンプ／よじ登り · ↓ しゃがむ · E 銃 · X 撃つ',
      note: 'v57 — 低い段差と拾得動作を正式にアニメ化し、浸水都市の背景にも生命を追加',
    },
    pad: 'native',
    status: 'active',
    note: 'v57 — low climbs and floor pickups now animate properly, with more living detail in the flooded city',
    title: 'Flash Prince',

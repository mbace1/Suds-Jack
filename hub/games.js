...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flowsnow.best', fmt: 'points' },
      ...
      controls: '← → kallista · ↑ kyyry · ↓ paino taakse: jarru kovalla, kellunta puuterissa · Väli ponnista · ilmassa ← → pyörähdys, ↑ ↓ voltti, Z grab · C katse taakse',
      note: 'v9 — kädet: kuusi nimettyä grabia, pyörähdykset ja voltit joihin on sitouduttava, jokainen maksettu riskinsä mukaan — ja lumi muistaa linjasi',
    },
    ja: {
      tagline: 'シンプルなスノーボード。夜明けから夕暮れまでの一本の滑走、板はパウダーに沈み速度で浮き上がる、雪は本物の粒子シミュレーション。',
      lineage: 'Journey × Sword of the Sea × Shredders',
      controls: '← → 傾ける · ↑ タック · ↓ 後ろ荷重：硬い雪ではブレーキ、パウダーでは浮力 · スペース ジャンプ · 空中：← → スピン、↑ ↓ フリップ、Z グラブ · C 振り返る',
      note: 'v9 — 手の技：名前のある六つのグラブ、踏み切るしかないスピンとフリップ、リスクに応じた得点 — そして雪は滑った跡を覚えている',
    },
    pad: 'native',
    status: 'active',
    note: 'v9 — the hands: six named grabs, spins and flips you have to commit to, each paid by what it risks — on snow that now remembers your line',
    title: 'Flowsnow',
    ...
    controls: '← → lean · ↑ tuck · ↓ weight back: brake on hardpack, float in powder · Space pop · in the air: ← → spin, ↑ ↓ flip, Z grab · C look back',
    path: 'flowsnow/',
    inRepo: true,
    accent: '#f4a27a',
    art: 'flowsnow',

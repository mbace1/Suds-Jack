...
export const GAMES = [
  ...
  },
  {
    id: 'tinyhawk',
      ...
      note: 'v4 — Skate-tyyliset viisto- ja sivupyyhkäisyt tekevät nyt temput suoraan maasta',
    },
    ja: {
      tagline: 'ほぼ真っ暗な公園で撮るスケートパート。スティックを溜め、弾き、つなぎを切らさない。',
      lineage: 'Skate Story × Tony Hawk',
      controls: '右スティック ↓＋↖ キックフリップ · ↗ ヒールフリップ · 横でポップショービット · 離す/↑ オーリー',
      note: 'v4 — Skate式の斜め・横フリックが地上から直接トリックにつながる',
    },
    pad: 'native',
    status: 'active',
    note: 'v4 — Skate-style diagonal and side flicks now launch kickflips, heelflips and pop shuvits from the ground',
    title: 'Tiny Hawk',

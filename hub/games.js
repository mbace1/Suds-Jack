...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      controls: 'A D juokse · Väli hyppää · E kiipeä koneeseen · W S puomi · S kaivaa tai nostaa',
      note: 'v4 — syvyys: leikkaus jalkojen alla, etuala joka rajaa kuvan, kamera joka vetäytyy näyttämään lukon',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: 'A D 走る · スペース ジャンプ · E 乗り込む · W S ブーム · S 掘る／吊る',
      note: 'v4 — 奥行きの層：足元は地層の断面、前景が画面を切り、カメラは引いて仕掛けを見せる',
    },
    pad: { keys: { left: 'KeyA', right: 'KeyD', up: 'KeyW', down: 'KeyS', a: 'Space', b: 'KeyE' } },
    status: 'active',
    note: 'v4 — the depth pass: a cut section under your feet, a foreground that crops the frame, a camera that pulls back to show you the lock',
    title: 'Eeri',
    ...
    controls: 'A D run · Space jump · E climb in · W S boom · hold S to dig or sling',
    path: 'eeri/',
    inRepo: true,
    accent: '#ffb01f',
    art: 'worksite',

...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'hyperDaggerHi', fmt: 'secs' },
      ...
      tagline: 'Devil Daggersista inspiroitunut riisuttu areena-FPS: luunvalkeat demonit, musta tyhjyys, leveä perusnäkymä ja kaksitoiminen taikatikari.',
      lineage: 'Devil Daggers',
      controls: 'WASD + hiiri · LMB napauta/pidä ampuaksesi · Väli ×2 hyppy · Vaihto syöksy · R/E REAP · Esc tauko',
    },
    ja: {
      tagline: 'Devil Daggersに着想を得た簡潔なアリーナFPS。骨白の悪魔、黒い虚空、広い通常視界、二形態の魔法短剣に集中。',
      lineage: 'Devil Daggers',
    ...
    status: 'active',
    title: 'Hyper Dagger',
    tagline: 'A stripped-down arena FPS inspired by Devil Daggers: bone-white demons, a black void, a conventional wide view, and a two-mode magic dagger.',
    lineage: 'Devil Daggers',

...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'powderBest', fmt: 'points' },
      ...
      tagline: 'Leijuva kilpa-alus avoimella tasangolla, jonka halkaisee kanjoni. Kuilun pohjan suola on pelin nopein maa; seinät ovat kuusikymmentä astetta. Etsi aukot.',
      lineage: 'leijusimulaatio × surrealistinen aavikko',
      controls: 'W kaasu · A D ohjaus · S jarru · Väli ylikuormitus · kaksi tikkua kosketuksella',
    },
    ja: {
      tagline: '峡谷に切り裂かれた開けた平原を走るホバーレーサー。リフト底の塩は最速の地面、壁は60度。突破口を見つけろ。',
      lineage: 'ホバーシム × シュールな砂漠',
      controls: 'W スロットル · A D ステア · S ブレーキ · スペース オーバードライブ · タッチは2本スティック',
    },
    status: 'active',
    note: 'rebuilt as a hover sim — four sprung pads, a turbine that spools, walls that are not special-cased. The field is still balanced blind',
    title: 'Powder',
    tagline: 'A hover racer on an open flatland cut by a canyon. The salt on the rift floor is the fastest ground there is; the walls are sixty degrees. Find the breaches.',
    lineage: 'hover sim × surreal desert',

...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.33 — kultapultit rakentavat nyt maailman rakennuksen: yhdeksän piilotettua osaa, ja työpäivän päätteeksi näet mitä sait pystyyn. Puuttuvat osat näkyvät teräskehikkoina — mikään ei jää lukkojen taakse.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.33 — 金のボルトがワールドの建物になった。隠された9個で組み上がり、仕事終わりに何が建ったか見られる。足りない部分は鉄骨のまま。何も鍵はかからない。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.33 — the golden bolts build something now: nine hidden across a world are the nine parts of the building that world was working on, and clocking out shows you what you put up. Missing parts stand as steel frames, so you can see exactly what is not there yet — and it never locks anything away.',
    title: 'Eeri',

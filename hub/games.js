...
export const GAMES = [
  {
    id: 'optionc-lab', hubHome: 'native', title: 'PIRITORI · NIGHT SHIFT C.16.1', status: 'active',
    path: 'piritori-c09/web/crew-run/?release=16.1', inRepo: true, pad: 'native', accent: '#9aebc7', art: 'tacticsyard',
    ...
    note: 'C.16.1 — Recessed windows and passages, worn surfaces and bounded wet reflections. Controller navigation restored in crew menus; graphics recovery retained. VIEW offers Tactical / Oblique / Overhead. Persistent crew outings; temporary stand-ins. Physical Pixel/iPad and final-art acceptance remain open.',
    fi: {tagline:'Valitse ryhmä. Tuo kaveri kotiin. Kohtaa seuraukset.', controls:'Valitse 2–3 hahmoa · Move + Act · Help / Extract · vedä kameraa', note:'C.16.1 — Syvemmät ikkunat ja käytävät, kuluneet pinnat ja märän pihan heijastukset. Kolme kamerakulmaa. Erillinen prototyyppi, väliaikaiset hahmot.'},
    ja: {tagline:'仲間を選び、救出し、その夜の結果を引き受ける。', controls:'2～3人を選択 · 移動＋行動 · 救助と脱出 · ドラッグでカメラ回転', note:'C.16.1 — 窓と通路の奥行き、使い込まれた表面、雨の反射を更新。3種類のカメラ。仮キャラクターによる独立した試作です。'},
  },
  {
  ...
  },
  {
    id: 'slaykallio',
      ...
      note: 'v43 — KOLMAS näytös: Veden Alla, kolmetoista uutta kohtaamista ja pomo jolla on kahdeksan liikettä ja neljä ehtoa. 26 uutta korttia, ja harvinaisimmat lukevat KELLONAJAN \u2014 päivällä kuollutta painolastia, yöllä pakan paras kortti.',
    },
    ja: {
      tagline: 'カッリオの厚い板橋。厚紙とブリキの人形、ネズミ、変異する粘塊、そして計算式を書き換える相棒たち。',
      lineage: 'Slay the Spire 2 × Balatro',
      controls: 'カードをタップ、次に敵をタップ · 1-9／矢印／E · パッドとタッチ対応',
      note: 'v43 — 第三幕「水の中」。新しい戦いが十三、そして八つの技と四つの条件を持つボス。新カード26枚、稀少なものは「時刻」を読む \u2014 昼はほぼ死に札、夜になれば山札で最強。',
    },
    pad: 'native',
    status: 'active',
    note: 'v43 — a THIRD act: In The Water, thirteen new spans and a boss with eight moves and four conditions. 26 new cards, and the rarest read the HOUR \u2014 nearly dead in the daylight act, the best card in the deck once night falls.',
    title: 'Slay Kallio',

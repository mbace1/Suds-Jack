...
export const GAMES = [
  ...
  },
  {
    id: 'tokomove',
      ...
      note: 'UUTTA: Kruunusillat — raitiovaunut 11 ja 12 sekä Kruunuvuori kartalla. Viisi testattavaa asiaa aloitusruudulla. Päivän vuoro, viiden vuoron viikko ja vuokra, tarkalla HSL-verkolla',
    },
    ja: {
      ...
      note: '新着：クルーヌ橋 — 11番・12番トラムとクルーヌヴオリが地図に。タイトル画面に試してほしいことが5つ。毎日のシフト、家賃の5日間の週、正確なHSL網で',
    },
    status: 'active',
    live: true,
    note: 'NEW: the Crown Bridges — trams 11 and 12 and Kruunuvuori are on the map. Five things to test on the title card. A daily shift, a week with rent due Friday, on the exact HSL network',
    title: 'Toko Move',

...
export const GAMES = [
  ...
  },
  {
    id: 'turf',
      ...
      note: 'v8 — kaksiosainen taisteluketju kokemuspisteineen ja aseryöstöineen; parannettu kosketuslayout.',
    },
    ja: {
      tagline: '雨に濡れた北欧の裏路地でのグリッド戦術。敵の狙いは先に見える、遮蔽物が本当に効く、三人のオペレーターが敵の一団に立ち向かう。',
      lineage: 'Into the Breach × Metal Slug Tactics',
      controls: 'オペレーターをタップ、次にマスか敵をタップ · キーボード/パッドにも対応',
      note: 'v8 — 経験値と武器ドロップのある二連戦、タッチ操作を改善。',
    },
    pad: 'native',
    status: 'active',
    note: 'v8 — a two-encounter run with XP/leveling and weapon-swap loot drops; improved touch layout and zoom.',
    title: 'TURF',

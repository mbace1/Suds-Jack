...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.45 — Maailma 1 sai toisen koneensa: höyrytela, joka tasoittaa rypistyneen pellin ajamalla sen yli — ei tähtäystä, ei painiketta pidettävänä, pelkkä ajaminen.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.45 — ワールド1に2台目の重機、ローラーが加わった——曲がった鉄板の上を走るだけで平らにする。狙いも、ボタン長押しも不要。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.45 — World 1 gets its second machine: the flattener, a road roller that drives a buckled sheet flat — no aiming, no holding a button, just driving over it.',
    title: 'Eeri',

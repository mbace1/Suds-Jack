...
export const GAMES = [
  ...
  },
  {
    id: 'tokomove',
      ...
      note: 'v10 — Vaihto: kaksi kerrosta käynnissä yhtä aikaa, ja yksi lasti joka siirtyy niiden välillä.',
    },
    ja: {
      ...
      note: 'v10 — ハンドオーバー：2つのレイヤーが同時に動き、荷物がその間で受け渡される。',
    },
    status: 'active',
    note: 'v10 — The Handover: two layers running at once, and one load that changes hands between them',
    title: 'Toko Move',

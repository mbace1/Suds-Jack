...
export const GAMES = [
...

  {
    id: 'eeri',
      ...
      note: 'v12 — kolme työmaata, tikkaat ja lippu joka rakentuu. Ohjaimella tai kosketuksella.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v12 — 現場は三つ、はしごと組み上がる旗。コントローラーでもタッチでも。',
    },
    pad: 'native',
    status: 'active',
    note: 'v12 — three sites, ladders to climb, and a flag that builds itself. Controller or touch.',
    title: 'Eeri',

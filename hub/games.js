...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'powderBest', fmt: 'points' },
      ...
      tagline: 'Rakettikelkka, joka käyttäytyy kuin etuvetoinen hot rod, hiekassa joka vajoaa ja siirtyy allasi. Loiva vuori, leveä kanjoni, sillat sen yli — tai sen alta.',
      lineage: 'etuvetokelkka × vajoava hiekka × PS2',
      controls: 'W kaasu · A D ohjaus · S jarru · Väli ylikuormitus · kaksi tikkua kosketuksella',
    },
    ja: {
      tagline: '前輪駆動のホットロッドのように振る舞うロケットそり。沈んでずれる砂、なだらかな山、広い峡谷、それを渡る橋 — 上も下も走れる。',
      lineage: '前輪駆動そり × 沈む砂 × PS2',
      controls: 'W スロットル · A D ステア · S ブレーキ · スペース オーバードライブ · タッチは2本スティック',
    },
    status: 'active',
    note: 'v4 — front-drive sleds and sinking sand, both measured rather than guessed; the field is still balanced blind',
    title: 'Powder',
    tagline: 'A rocket sled that drives like a front-wheel-drive hot rod, on sand that sinks and shifts under you. A mellow mountain, a wide canyon, and bridges to cross it — or run under.',
    lineage: 'front-drive sled × sinking sand × PS2',
    tags: ['racing', 'sim', 'three.js'],
    controls: 'W throttle · A D steer · S brake · Space overdrive · twin sticks on touch',
    path: 'powder/',
    inRepo: true,
    accent: '#c8a0e8',
    art: 'powder',

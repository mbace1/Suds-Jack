...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'kahden tikun Conrad-liiketutkielma: 10 kuvan paikallaan käännös ja 14 kuvan juoksukäännös liittyvät uuteen juoksuun ja hyppyihin · klassinen / 4×',
    },
    ja: {
      tagline: '一つひとつの動きを作り直しているシネマティック・プラットフォーマー。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '左スティックで走る · 右スティック↑／押し込みでジャンプ · キーボード ← → + ↑／スペース',
      note: 'ツインスティック式Conrad動作テスト：10フレーム立ちターンと14フレーム走行反転を追加 · クラシック／4×表示',
    },
    pad: 'native',
    status: 'active',
    note: 'twin-stick Conrad-motion study: 10-frame stand turn and 14-frame running reversal join the rebuilt run and jumps · Classic / 4×',
    title: 'Flash Prince',

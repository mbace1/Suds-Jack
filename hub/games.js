...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'v66 — hybridi vastaa kilpeen rauhanomaisesti tai puolustaa puutarhaa taistelussa',
    },
    ja: {
      tagline: '始めた動きは必ず終わる。ぶら下がり、よじ登り、相手より先に銃を抜く。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 歩く（長押しで走る）· ↑ ジャンプ／よじ登り · ↓ しゃがむ · E 銃 · X 撃つ',
      note: 'v66 — ハイブリッドは盾の合図に応え、攻撃すれば庭を守るため戦う',
    },
    pad: 'native',
    status: 'active',
    note: 'v66 — answer the hybrid with your shield or provoke a fight; either choice completes the facility mission',
    title: 'Flash Prince',
  ...
  },
  {
    id: 'turf',
      ...
      note: 'v21 — viisi taistelua, kokemuspisteet, aseet ja pikkuesineet, palavat ruudut ja porraskuilut sekä viholliset joilla on oma taistelutapa.',
    },
    ja: {
      tagline: '雨に濡れた北欧の裏路地でのグリッド戦術。敵の狙いは先に見え、遮蔽物が本当に効き、階段の吹き抜けへ突き飛ばす方が撃つより確実に倒せる。',
      lineage: 'Into the Breach × Metal Slug Tactics',
      controls: 'オペレーターをタップ、次にマスか敵をタップ · キーボード/パッドにも対応',
      note: 'v21 — 5つの戦闘、経験値・武器・装身具のドロップ、燃える床と吹き抜け、そしてそれぞれ独自の戦い方をする敵。',
    },
    pad: 'native',
    status: 'active',
    note: 'v21 — five encounters, XP, weapon drops and trinkets, burning tiles and open stairwells, and enemies that each fight their own way.',
    title: 'TURF',

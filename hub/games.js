...
export const GAMES = [
  {
    ...
    score: { key: 'sudsJack.horizon.best', fmt: 'points' },
      ...
      note: 'v3 — saapuvat kohteet, pisteet, osumat, aallot ja pelin loppu muodostavat nyt toimivan selviytymiskierroksen',
    },
    ja: {
      tagline: '9レーンのベクタースコアアタック。オーブをつなぎ、クローラーを踏み、地平線を読む。',
      controls: '← → / A D 移動 · スペース ジャンプ · パッド／タッチ対応',
      note: 'v3 — 接近、得点、ダメージ、ウェーブ、ゲームオーバーが一つのサバイバルループとして動作',
    },
    pad: 'native',
    status: 'active',
    note: 'v3 — arrivals, scoring, damage, waves and game over now form one working survival loop',
    title: 'Suds Jack',
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.22 — kaikki neljä maailmaa maalattu ja 12 kenttää valikossa. Kahdeksan työkonetta ja yhdeksän työmaakapinetta mallinnettu, ja Eeri osaa nyt seistä paikallaan uskottavasti. Latautuu nyt selvästi kevyempänä.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.22 — 4つのワールドすべてに専用の背景、12ステージすべてがメニューに。重機8台と現場道具9点をモデリング。待機中の仕草や崖際のためらいも追加。読み込みも大幅に軽量化。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.22 — all four worlds painted, all twelve levels in the pause menu, and it loads far lighter than it did: the backdrops went 31 MB to 5.9 MB and the models 56 MB to 30 MB. Eight worksite machines plus a nine-piece site kit are modelled, and Eeri has something to do while you are not moving: idle breaks, a hesitation at the edge of a drop, a proper climb on and off a ladder.',
    title: 'Eeri',
  ...
  },
  {
    ...
    title: 'Kindling',
    tagline: 'Five small things tend a fire. Three kindling opens a walk. Miss two days and your monster becomes kindling — not a scolding, a story.',
    lineage: 'Finch, in a ruin',
    tags: ['care', 'daily', 'pixel'],
    controls: 'tap the list · walk the ruin · keep what follows you home',
    path: 'kindling/',
    inRepo: true,
    accent: '#f0a24a',
    art: 'hearth',
  ...
  },
  {
    id: 'piritori',
      ...
      note: 'huoneet joihin astut sisään, tappelut joissa on ihmisiä — ja yhä arvoituksellinen Eden',
    },
    ja: {
      tagline: 'ドープウォーズ × ミニメトロ。2003年のカッリオに線を引き、荷を流し、借金を返す — 七つの夜。',
      lineage: 'ドープウォーズ × ミニメトロ × エデンの東',
      controls: '駅から駅へドラッグで路線 · 駅をタップで取引 · 戦闘はターン制',
      note: '入っていける部屋、人が立っている戦闘 — エデンは謎のまま',
    },
    status: 'active',
    note: 'rooms you walk into, fights with people standing in them, and an Eden that stays a mystery',
    title: 'Piritori → Eden',

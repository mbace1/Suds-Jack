...
export const GAMES = [
  ...
  },
  {
    id: 'tokomove',
      ...
      note: 'v14 — Jokaisella ratikkalinjalla oma värinsä kartan alla, ei enää yhtä harmaata viivaa.',
    },
    ja: {
      ...
      note: 'v14 — 各路面電車の路線が地図の下で自分の色を持つ。もう一本の灰色の線ではない。',
    },
    status: 'active',
    note: 'v14 — the real network under the board now reads in colour, one hue per tram line and its own for the metro, not one grey path',
    title: 'Toko Move',

...
export const GAMES = [
  ...
  },
  {
    id: 'piritori',
      ...
      note: 'Act I v4.55 — katso ennen kuin lähdet: Aatami kulkee itse kartalla · fi/en/ja',
    },
    ja: {
      ...
      note: 'Act I v4.55 — 見るだけでは動かない：アータミは自分で歩いて移動する · fi/en/ja',
    },
    status: 'active',
    note: 'Act I v4.55 — look before you go: tapping the map only inspects, and Aatami travels himself',
    title: 'Piritori → Eden',

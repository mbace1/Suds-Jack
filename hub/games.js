...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.25 — vaakatasossa kuva on nyt 56% leveämpi: piirretty ohjainlevy on poissa ja napit — nuolet, A ja B — ovat pieninä alhaalla. Tasanteilla on paksuutta, ja Eerillä on ääriviiva, joten hänet löytää aina.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.25 — 横持ちで画面が56%広くなった。描かれた操作盤をやめ、ボタン（矢印・A・B）だけを小さく下に配置。足場に厚みがつき、エエリには輪郭線がついて見失わない。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.25 — all four worlds painted, all twelve levels in the pause menu. Held sideways the picture is now 56% wider: the drawn control board is gone and the buttons themselves — arrows, A and B — sit small and low over the game. Platforms have thickness, and the kid has an outline so you can always find him.',
    title: 'Eeri',

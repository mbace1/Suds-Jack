...
export const GAMES = [
  ...
  },
  {
    id: 'tinyhawk',
      ...
      note: 'arkistoitu v6:een — skeittilinja siirtyi CONCRETEen; suunnitteluluovutus concrete/HANDOFF_TINYHAWK.md',
    },
    ja: {
      tagline: '丸々とした鳥が、ほぼ真っ暗な公園でスケートパートを撮る。スティックを溜め、弾き、つなぎを切らさない。',
      lineage: 'Skate Story × Tony Hawk',
      controls: '右スティック ↓＋↖/↗ フリップ · 横でショービット · ライン着地でSPECIALを溜める',
      note: 'v6でアーカイブ — スケート開発は CONCRETE へ。設計の引き継ぎは concrete/HANDOFF_TINYHAWK.md',
    },
    pad: 'native',
    status: 'archived',
    note: 'archived at v6 — the skating lane moved to CONCRETE; design hand-off in concrete/HANDOFF_TINYHAWK.md',
    title: 'Tiny Hawk',

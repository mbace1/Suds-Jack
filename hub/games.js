...
export const GAMES = [
...

  {
    id: 'eeri',
      ...
      note: 'v11 — kolme kenttää, jokainen yhdestä asiasta: hyppy päälle, kiipeäminen, molemmat. Sata pulttia ja kolme kultaista kentässä',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · ▲ ▼ 登る · Ⓑ 乗り込む',
      note: 'v11 — 三つのステージ、それぞれ一つのアイデア：踏みつけ、はしご、その両方。ボルト百個と隠し金ボルト三個',
    },
    pad: { keys: { left: 'KeyA', right: 'KeyD', up: 'KeyW', down: 'KeyS', a: 'Space', b: 'KeyE' } },
    status: 'active',
    note: 'v11 — three levels, one idea each: the stomp, the climb, then both and the crane. A hundred bolts and three hidden golden ones per level, a midway checkpoint, and a flag that builds itself as you arrive',
    title: 'Eeri',

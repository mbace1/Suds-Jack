...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'v53 — tulvinut liikennekeskus, ensimmäinen VHS-arkistonauha ja elävän laitoksen valosignaalit',
    },
    ja: {
      tagline: '始めた動きは必ず終わる。ぶら下がり、よじ登り、相手より先に銃を抜く。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 歩く（長押しで走る）· ↑ ジャンプ／よじ登り · ↓ しゃがむ · E 銃 · X 撃つ',
      note: 'v53 — 浸水した交通ハブ、最初のVHSアーカイブテープ、生きた施設の光信号',
    },
    pad: 'native',
    status: 'active',
    note: 'v53 — Hub launch opens the flooded city directly: VHS archive tape, stronger wading wakes and living facility signals',
    title: 'Flash Prince',
  ...
  },
  {
    id: 'turf',
      ...
      note: 'v6 — kaksiosainen taisteluketju, kokemuspisteet taistelujen välissä, näppäimistö- ja ohjaintuki.',
    },
    ja: {
      tagline: '雨に濡れた北欧の裏路地でのグリッド戦術。敵の狙いは先に見える、遮蔽物が本当に効く、三人のオペレーターが敵の一団に立ち向かう。',
      lineage: 'Into the Breach × Metal Slug Tactics',
      controls: 'オペレーターをタップ、次にマスか敵をタップ · キーボード/パッドにも対応',
      note: 'v6 — 戦闘間で経験値が入る二連戦、キーボードとパッド対応。',
    },
    pad: 'native',
    status: 'active',
    note: 'v6 — a two-encounter run with XP/leveling between fights, keyboard and gamepad supported.',
    title: 'TURF',

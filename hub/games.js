...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v14 — kolme kenttää, hihnat ja pressut, välitarkastuspiste ja kultapultit.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v14 — 三つの現場、ベルトと幌、中間チェックポイントと金のボルト。',
    },
    pad: 'native',
    status: 'active',
    note: 'v14 — three named levels, belts and tarps, a midway checkpoint and golden bolts to find.',
    title: 'Eeri',

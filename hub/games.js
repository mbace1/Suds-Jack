...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      note: 'kahden tikun rasteriliiketutkielma: juoksu, pysähdys, hyppy ja laskeutuminen · klassinen / 4× skaalaus',
    },
    ja: {
      tagline: '一つひとつの動きを作り直しているシネマティック・プラットフォーマー。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '左スティックで走る · 右スティック↑／押し込みでジャンプ · キーボード ← → + ↑／スペース',
      note: 'ツインスティック式ラスター動作テスト：走る、止まる、跳ぶ、着地 · クラシック／4×表示',
    },
    pad: 'native',
    status: 'active',
    note: 'twin-stick raster-motion study: run, stop, jump and land · Classic Pixels / 4× Upscale',
    title: 'Flash Prince',

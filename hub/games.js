...
export const GAMES = [
  ...
  },
  {
    id: 'slaykallio',
      ...
      note: 'v44 — näytöksen läpäisy jättää yhden kortin taakse, joten pakka TERÄVÖITYY matkan varrella eikä vain kasva. Kolmas näytös Veden Alla, kolmetoista uutta kohtaamista, ja kortteja jotka lukevat kellonaikaa.',
    },
    ja: {
      tagline: 'カッリオの厚い板橋。厚紙とブリキの人形、ネズミ、変異する粘塊、そして計算式を書き換える相棒たち。',
      lineage: 'Slay the Spire 2 × Balatro',
      controls: 'カードをタップ、次に敵をタップ · 1-9／矢印／E · パッドとタッチ対応',
      note: 'v44 — 幕を越えるたびにカードを一枚置いていく。山札はただ膨らむのではなく、進むほど研ぎ澄まされる。第三幕「水の中」、新しい戦いが十三、そして時刻を読むカード。',
    },
    pad: 'native',
    status: 'active',
    note: 'v44 — clearing an act now leaves one card behind, so the deck finally gets SHARPER as the run gets longer instead of just bigger. Act three: In The Water, thirteen new spans, and cards that read the hour.',
    title: 'Slay Kallio',

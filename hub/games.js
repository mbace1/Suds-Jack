...
export const GAMES = [
  ...
  },
  {
    ...
    score: { key: 'hyperDaggerHi', fmt: 'secs' },
      ...
      tagline: 'Devil Daggersista inspiroitunut riisuttu areena-FPS: leveäsarviset luudemonit, mustanpunainen tyhjyys, leveä perusnäkymä ja nelisorminen taikatikari.',
      lineage: 'Devil Daggers',
      controls: 'WASD + hiiri · LMB napauta/pidä ampuaksesi · Väli ×2 hyppy · Vaihto syöksy · R/E REAP · Esc tauko',
    },
    ja: {
      tagline: 'Devil Daggersに着想を得た簡潔なアリーナFPS。横に広い角付きの骨の悪魔、黒赤の虚空、広い通常視界、四本指の魔法短剣に集中。',
      lineage: 'Devil Daggers',
    ...
    status: 'active',
    title: 'Hyper Dagger',
    tagline: 'A stripped-down arena FPS inspired by Devil Daggers: wide horned skulls, a black-red void, a conventional wide view, and a four-finger magic dagger.',
    lineage: 'Devil Daggers',
  ...
  },
  {
    ...
    score: { key: 'flashPrinceBest', fmt: 'best-time' },
      ...
      controls: '← → juokse · ↑ / Väli pitkä hyppy · vapauta pysähtyäksesi · vastasuunta kääntyy',
      note: 'rasteriliikkeeseen keskittyvä versio: juoksu, pysähdys, suunnanvaihto, hyppy ja laskeutuminen — koko reitti on väliaikaisesti sivussa',
    },
    ja: {
      tagline: '一つひとつの動きを作り直しているシネマティック・プラットフォーマー。',
      lineage: 'Another World × Flashback × Prince of Persia',
      controls: '← → 走る · ↑ / スペース ロングジャンプ · 離して停止 · 逆方向で切り返し',
      note: 'ラスター動作に絞った再構築版：走る、止まる、反転、跳ぶ、着地。全14画面のルートは一時保留',
    },
    pad: 'native',
    status: 'active',
    note: 'focused raster-motion rebuild: run, stop, reverse, jump and land — the full fourteen-screen route is temporarily parked',
    title: 'Flash Prince',
    tagline: 'A cinematic platformer being rebuilt one committed movement at a time.',
    lineage: 'Another World × Flashback × Prince of Persia',
    tags: ['cinematic', 'raster', 'canvas'],
    controls: '← → run · ↑ / Space long jump · release to stop · reverse to plant and turn',
    path: 'flashprince/',
    inRepo: true,
    accent: '#c8ee5a',
    art: 'ledge',

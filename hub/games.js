...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.46 — Maailma 2 sai oman laitteensa: kallistuva lankku ojan yli. Ei painiketta, ei sykliä — se vastaa painoon. Seiso missä tahansa muualla kuin keskellä, ja se puoli vajoaa.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.46 — ワールド2に専用の仕掛け、傾く板が加わった。ボタンもサイクルもなく、重さに応える——真ん中以外に立つとその側が沈む。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.46 — World 2 gets its own gizmo: a tipping plank over a trench. No button, no cycle — it answers weight. Stand anywhere but centre and that side sinks.',
    title: 'Eeri',

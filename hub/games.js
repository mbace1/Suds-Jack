...
export const GAMES = [
  ...
  },
  {
    id: 'eeri',
      ...
      note: 'v15.43 — Editorin pelilajikerros osaa nyt sijoittaa oikeita vihollisia ja höyrysuuttimia — ei enää vain viitteitä. Löytyi myös vanha bugi: kohdistus ei aina osunut taustan taakse.',
    },
    ja: {
      tagline: '工事現場の子ども。重機によじ登って運転できる。ショベルを走らせ、ブームを上げ、鉄球をかわす。',
      lineage: 'マリオ3 × ヨッシークラフトワールド × トンカ',
      controls: '◀ ▶ 走る · Ⓐ ジャンプ · Ⓑ 乗り込む · ▲ ▼ ブーム · ▼長押しで掘る',
      note: 'v15.43 — エディタのゲームプレイ層で敵や蒸気弁を実際に配置できるように。制作中に見つけた古いバグも修正——選択判定が背景の奥まで届いていなかった。',
    },
    pad: 'native',
    status: 'active',
    note: 'v15.43 — The editor can now place real enemies and steam vents, not just reference them. Building it found a real bug along the way: picking never reliably reached anything behind the painted backdrop — fixed for every layer, not just this one.',
    title: 'Eeri',

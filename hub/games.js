...
export const GAMES = [
  ...
  },
  {
    id: 'tokomove',
      ...
      note: 'UUTTA: hiljainen kartta ja LIVE — viisi testattavaa asiaa aloitusruudulla. Päivän vuoro, viiden vuoron viikko ja vuokra, tarkalla HSL-verkolla',
    },
    ja: {
      ...
      note: '新着：静かな地図とLIVE — タイトル画面に試してほしいことが5つ。毎日のシフト、家賃の5日間の週、正確なHSL網で',
    },
    status: 'active',
    live: true,
    note: 'NEW: the quiet map and LIVE — five things to test on the title card. A daily shift, a week with rent due Friday, on the exact HSL network',
    title: 'Toko Move',

...
function buildTokoCabinet(){
  ...
  const tagline=document.createElement('p');lineage.className='lineage';tagline.className='tagline';tagline.textContent='Talk to Toko face to face. Deep project memory, opinions, design debate, factual news — now with a dedicated Toko Move brain.';
  ...
  const note=document.createElement('p');note.className='note';note.textContent='v29 — Toko Move design conversations';
